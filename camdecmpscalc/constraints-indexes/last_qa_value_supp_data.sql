ALTER TABLE IF EXISTS camdecmpscalc.last_qa_value_supp_data
    ADD CONSTRAINT pk_last_qa_value_supp_data PRIMARY KEY (pk),
    ADD CONSTRAINT fk_last_qa_value_supp_data_check_session FOREIGN KEY (chk_session_id)
...
CREATE INDEX IF NOT EXISTS idx_last_qa_value_supp_data_chk_session_id
    ON camdecmpscalc.last_qa_value_supp_data USING btree
