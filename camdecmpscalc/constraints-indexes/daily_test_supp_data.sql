ALTER TABLE IF EXISTS camdecmpscalc.daily_test_supp_data
    ADD CONSTRAINT pk_daily_test_supp_data PRIMARY KEY (pk),
   	ADD CONSTRAINT fk_daily_test_supp_data_check_session FOREIGN KEY (chk_session_id)
...
CREATE INDEX IF NOT EXISTS idx_daily_test_supp_data_chk_session_id
    ON camdecmpscalc.daily_test_supp_data USING btree
