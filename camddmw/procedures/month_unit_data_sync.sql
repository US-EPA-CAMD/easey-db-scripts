...
AS $BODY$
BEGIN
	DELETE FROM camddmw.month_unit_data mud
	USING (
		SELECT unit_id, op_year, op_month
		FROM camddmw.month_unit_data_log
	...
	INSERT INTO camddmw.month_unit_data
	...
	FROM camddmw.month_unit_data_log l
	JOIN (
	...
	UPDATE camddmw.month_unit_data mud
