CREATE TABLE camddmw.hour_unit_data
(
    ...
    add_date date,
    CONSTRAINT hour_unit_data_pk PRIMARY KEY (unit_id, op_date, op_hour)
...
-- Index: hour_unit_data_prd_ix

-- DROP INDEX camddmw.hour_unit_data_prd_ix;

CREATE INDEX hour_unit_data_prd_ix
