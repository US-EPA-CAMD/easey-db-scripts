...
CREATE TABLE camddmw.rep_year_dim
(
...
CREATE TABLE camddmw.rep_year_dim_rep_year_dm_p1 PARTITION OF camddmw.rep_year_dim
    FOR VALUES FROM (MINVALUE) TO ('1996');

CREATE TABLE camddmw.rep_year_dim_rep_year_dm_p10 PARTITION OF camddmw.rep_year_dim
    FOR VALUES FROM ('2004') TO ('2005');

CREATE TABLE camddmw.rep_year_dim_rep_year_dm_p11 PARTITION OF camddmw.rep_year_dim
    FOR VALUES FROM ('2005') TO ('2006');

CREATE TABLE camddmw.rep_year_dim_rep_year_dm_p12 PARTITION OF camddmw.rep_year_dim
    FOR VALUES FROM ('2006') TO ('2007');

CREATE TABLE camddmw.rep_year_dim_rep_year_dm_p13 PARTITION OF camddmw.rep_year_dim
    FOR VALUES FROM ('2007') TO ('2008');

CREATE TABLE camddmw.rep_year_dim_rep_year_dm_p14 PARTITION OF camddmw.rep_year_dim
    FOR VALUES FROM ('2008') TO ('2009');

CREATE TABLE camddmw.rep_year_dim_rep_year_dm_p15 PARTITION OF camddmw.rep_year_dim
    FOR VALUES FROM ('2009') TO ('2010');

CREATE TABLE camddmw.rep_year_dim_rep_year_dm_p16 PARTITION OF camddmw.rep_year_dim
    FOR VALUES FROM ('2010') TO ('2011');

CREATE TABLE camddmw.rep_year_dim_rep_year_dm_p17 PARTITION OF camddmw.rep_year_dim
    FOR VALUES FROM ('2011') TO ('2012');

CREATE TABLE camddmw.rep_year_dim_rep_year_dm_p18 PARTITION OF camddmw.rep_year_dim
    FOR VALUES FROM ('2012') TO ('2013');

CREATE TABLE camddmw.rep_year_dim_rep_year_dm_p19 PARTITION OF camddmw.rep_year_dim
    FOR VALUES FROM ('2013') TO ('2014');

CREATE TABLE camddmw.rep_year_dim_rep_year_dm_p2 PARTITION OF camddmw.rep_year_dim
    FOR VALUES FROM ('1996') TO ('1997');

CREATE TABLE camddmw.rep_year_dim_rep_year_dm_p20 PARTITION OF camddmw.rep_year_dim
    FOR VALUES FROM ('2014') TO ('2015');

CREATE TABLE camddmw.rep_year_dim_rep_year_dm_p21 PARTITION OF camddmw.rep_year_dim
    FOR VALUES FROM ('2015') TO ('2016');

CREATE TABLE camddmw.rep_year_dim_rep_year_dm_p22 PARTITION OF camddmw.rep_year_dim
    FOR VALUES FROM ('2016') TO ('2017');

CREATE TABLE camddmw.rep_year_dim_rep_year_dm_p23 PARTITION OF camddmw.rep_year_dim
    FOR VALUES FROM ('2017') TO ('2018');

CREATE TABLE camddmw.rep_year_dim_rep_year_dm_p24 PARTITION OF camddmw.rep_year_dim
    FOR VALUES FROM ('2018') TO ('2019');

CREATE TABLE camddmw.rep_year_dim_rep_year_dm_p25 PARTITION OF camddmw.rep_year_dim
    FOR VALUES FROM ('2019') TO ('2020');

CREATE TABLE camddmw.rep_year_dim_rep_year_dm_p26 PARTITION OF camddmw.rep_year_dim
    FOR VALUES FROM ('2020') TO ('2021');

CREATE TABLE camddmw.rep_year_dim_rep_year_dm_p27 PARTITION OF camddmw.rep_year_dim
    FOR VALUES FROM ('2021') TO ('2022');

CREATE TABLE camddmw.rep_year_dim_rep_year_dm_p28 PARTITION OF camddmw.rep_year_dim
    FOR VALUES FROM ('2022') TO ('2023');

CREATE TABLE camddmw.rep_year_dim_rep_year_dm_p3 PARTITION OF camddmw.rep_year_dim
    FOR VALUES FROM ('1997') TO ('1998');

CREATE TABLE camddmw.rep_year_dim_rep_year_dm_p4 PARTITION OF camddmw.rep_year_dim
    FOR VALUES FROM ('1998') TO ('1999');

CREATE TABLE camddmw.rep_year_dim_rep_year_dm_p5 PARTITION OF camddmw.rep_year_dim
    FOR VALUES FROM ('1999') TO ('2000');

CREATE TABLE camddmw.rep_year_dim_rep_year_dm_p6 PARTITION OF camddmw.rep_year_dim
    FOR VALUES FROM ('2000') TO ('2001');

CREATE TABLE camddmw.rep_year_dim_rep_year_dm_p7 PARTITION OF camddmw.rep_year_dim
    FOR VALUES FROM ('2001') TO ('2002');

CREATE TABLE camddmw.rep_year_dim_rep_year_dm_p8 PARTITION OF camddmw.rep_year_dim
    FOR VALUES FROM ('2002') TO ('2003');

CREATE TABLE camddmw.rep_year_dim_rep_year_dm_p9 PARTITION OF camddmw.rep_year_dim
