CREATE TABLE camddmw.transaction_fact
(
    ...
    CONSTRAINT trnsctn_fact_pk PRIMARY KEY (transaction_id, prg_code)
...
CREATE TABLE camddmw.transaction_fact_trans_fact_p1 PARTITION OF camddmw.transaction_fact
    FOR VALUES IN ('ARP');

--ALTER TABLE camddmw.transaction_fact_trans_fact_p1
--    OWNER to "uImcwuf4K9dyaxeL";

CREATE TABLE camddmw.transaction_fact_trans_fact_p2 PARTITION OF camddmw.transaction_fact
    FOR VALUES IN ('NBP');

--ALTER TABLE camddmw.transaction_fact_trans_fact_p2
--    OWNER to "uImcwuf4K9dyaxeL";

CREATE TABLE camddmw.transaction_fact_trans_fact_unknown PARTITION OF camddmw.transaction_fact
    DEFAULT;
