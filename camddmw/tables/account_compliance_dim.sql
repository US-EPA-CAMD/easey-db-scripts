CREATE TABLE camddmw.account_compliance_dim
(
    ...
    CONSTRAINT account_compliance_dim_fk FOREIGN KEY (prg_code, account_number)
        REFERENCES camddmw.account_fact (prg_code, account_number) MATCH SIMPLE
        ON UPDATE NO ACTION
        ON DELETE CASCADE
);
