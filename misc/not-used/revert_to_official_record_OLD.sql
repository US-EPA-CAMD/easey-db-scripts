-- PROCEDURE: camdecmpswks.revert_to_official_record_old(text)

-- DROP PROCEDURE camdecmpswks.revert_to_official_record_old(text);

CREATE OR REPLACE PROCEDURE camdecmpswks.revert_to_official_record_old(
	monplanid text)
LANGUAGE 'plpgsql'
AS $BODY$
BEGIN
