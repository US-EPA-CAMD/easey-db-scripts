  ...
  from  (
            select  fac.oris_code,
              ...
              from  sel
                    ...
                    join camddmw.HOUR_UNIT_DATA dat using ( unit_id, op_year )
             group
                by  fac.oris_code,
                    fac.facility_name,
                    unt.unitid,
            ...
            select  fac.oris_code,
              ...
              from  sel
                    join camd.PLANT fac using ( oris_code )
                    join camd.UNIT unt using ( fac_id, unitid )
                    join camddmw.DAY_UNIT_DATA dat using ( unit_id, op_year )
             group
                by  fac.oris_code,
                    fac.facility_name,
                    unt.unitid,
            ...
            select  fac.oris_code,
              ...
              from  sel
                    join camd.PLANT fac using ( oris_code )
                    join camd.UNIT unt using ( fac_id, unitid )
                    join camddmw.MONTH_UNIT_DATA dat using ( unit_id, op_year )
             group
                by  fac.oris_code,
                    fac.facility_name,
                    unt.unitid,
            ...
            select  fac.oris_code,
                    fac.facility_name,
                    unt.unitid as unit_name,
                    'Quarter' Period, 4 Ord, dat.op_year,
                    sum(dat.sum_op_time) op_time,
                    sum(dat.count_op_time) op_hours,
                    sum(dat.gload) gload,
                    sum(dat.sload) sload,
              ...
              from  sel
                    join camd.PLANT fac using ( oris_code )
                    join camd.UNIT unt using ( fac_id, unitid )
                    join camddmw.QUARTER_UNIT_DATA dat using ( unit_id, op_year )
             group
                by  fac.oris_code,
                    fac.facility_name,
                    unt.unitid,
            ...
            select  fac.oris_code,
              ...
              from  sel
                    join camd.PLANT fac using ( oris_code )
                    join camd.UNIT unt using ( fac_id, unitid )
                    join camddmw.ANNUAL_UNIT_DATA dat using ( unit_id, op_year )
             group
                by  fac.oris_code,
                    fac.facility_name,
                    unt.unitid,
