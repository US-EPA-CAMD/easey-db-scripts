...
SELECT 'camdaux' AS schema_name, 'program_parameter' AS table_name, COUNT(*) FROM camdaux.program_parameter UNION ALL
...
SELECT 'camdecmps' AS schema_name, 'dm_emissions_user' AS table_name, COUNT(*) FROM camdecmps.dm_emissions_user UNION ALL
...
/*
SELECT 'camdecmpswks' AS schema_name, 'ae_correlation_test_run' AS table_name, COUNT(*) FROM camdecmpswks.ae_correlation_test_run UNION ALL
SELECT 'camdecmpswks' AS schema_name, 'ae_correlation_test_sum' AS table_name, COUNT(*) FROM camdecmpswks.ae_correlation_test_sum UNION ALL
SELECT 'camdecmpswks' AS schema_name, 'ae_hi_gas' AS table_name, COUNT(*) FROM camdecmpswks.ae_hi_gas UNION ALL
SELECT 'camdecmpswks' AS schema_name, 'ae_hi_oil' AS table_name, COUNT(*) FROM camdecmpswks.ae_hi_oil UNION ALL
SELECT 'camdecmpswks' AS schema_name, 'air_emission_testing' AS table_name, COUNT(*) FROM camdecmpswks.air_emission_testing UNION ALL
SELECT 'camdecmpswks' AS schema_name, 'analyzer_range' AS table_name, COUNT(*) FROM camdecmpswks.analyzer_range UNION ALL
SELECT 'camdecmpswks' AS schema_name, 'calibration_injection' AS table_name, COUNT(*) FROM camdecmpswks.calibration_injection UNION ALL
SELECT 'camdecmpswks' AS schema_name, 'check_log' AS table_name, COUNT(*) FROM camdecmpswks.check_log UNION ALL
SELECT 'camdecmpswks' AS schema_name, 'check_session' AS table_name, COUNT(*) FROM camdecmpswks.check_session UNION ALL
SELECT 'camdecmpswks' AS schema_name, 'component' AS table_name, COUNT(*) FROM camdecmpswks.component UNION ALL
SELECT 'camdecmpswks' AS schema_name, 'cycle_time_injection' AS table_name, COUNT(*) FROM camdecmpswks.cycle_time_injection UNION ALL
SELECT 'camdecmpswks' AS schema_name, 'cycle_time_summary' AS table_name, COUNT(*) FROM camdecmpswks.cycle_time_summary UNION ALL
SELECT 'camdecmpswks' AS schema_name, 'flow_rata_run' AS table_name, COUNT(*) FROM camdecmpswks.flow_rata_run UNION ALL
SELECT 'camdecmpswks' AS schema_name, 'flow_to_load_check' AS table_name, COUNT(*) FROM camdecmpswks.flow_to_load_check UNION ALL
SELECT 'camdecmpswks' AS schema_name, 'flow_to_load_reference' AS table_name, COUNT(*) FROM camdecmpswks.flow_to_load_reference UNION ALL
SELECT 'camdecmpswks' AS schema_name, 'fuel_flow_to_load_baseline' AS table_name, COUNT(*) FROM camdecmpswks.fuel_flow_to_load_baseline UNION ALL
SELECT 'camdecmpswks' AS schema_name, 'fuel_flow_to_load_check' AS table_name, COUNT(*) FROM camdecmpswks.fuel_flow_to_load_check UNION ALL
SELECT 'camdecmpswks' AS schema_name, 'fuel_flowmeter_accuracy' AS table_name, COUNT(*) FROM camdecmpswks.fuel_flowmeter_accuracy UNION ALL
SELECT 'camdecmpswks' AS schema_name, 'hg_test_injection' AS table_name, COUNT(*) FROM camdecmpswks.hg_test_injection UNION ALL
SELECT 'camdecmpswks' AS schema_name, 'hg_test_summary' AS table_name, COUNT(*) FROM camdecmpswks.hg_test_summary UNION ALL
SELECT 'camdecmpswks' AS schema_name, 'linearity_injection' AS table_name, COUNT(*) FROM camdecmpswks.linearity_injection UNION ALL
SELECT 'camdecmpswks' AS schema_name, 'linearity_summary' AS table_name, COUNT(*) FROM camdecmpswks.linearity_summary UNION ALL
SELECT 'camdecmpswks' AS schema_name, 'mats_method_data' AS table_name, COUNT(*) FROM camdecmpswks.mats_method_data UNION ALL
SELECT 'camdecmpswks' AS schema_name, 'monitor_default' AS table_name, COUNT(*) FROM camdecmpswks.monitor_default UNION ALL
SELECT 'camdecmpswks' AS schema_name, 'monitor_formula' AS table_name, COUNT(*) FROM camdecmpswks.monitor_formula UNION ALL
SELECT 'camdecmpswks' AS schema_name, 'monitor_load' AS table_name, COUNT(*) FROM camdecmpswks.monitor_load UNION ALL
SELECT 'camdecmpswks' AS schema_name, 'monitor_location' AS table_name, COUNT(*) FROM camdecmpswks.monitor_location UNION ALL
SELECT 'camdecmpswks' AS schema_name, 'monitor_location_attribute' AS table_name, COUNT(*) FROM camdecmpswks.monitor_location_attribute UNION ALL
SELECT 'camdecmpswks' AS schema_name, 'monitor_method' AS table_name, COUNT(*) FROM camdecmpswks.monitor_method UNION ALL
SELECT 'camdecmpswks' AS schema_name, 'monitor_plan' AS table_name, COUNT(*) FROM camdecmpswks.monitor_plan UNION ALL
SELECT 'camdecmpswks' AS schema_name, 'monitor_plan_comment' AS table_name, COUNT(*) FROM camdecmpswks.monitor_plan_comment UNION ALL
SELECT 'camdecmpswks' AS schema_name, 'monitor_plan_location' AS table_name, COUNT(*) FROM camdecmpswks.monitor_plan_location UNION ALL
SELECT 'camdecmpswks' AS schema_name, 'monitor_plan_reporting_freq' AS table_name, COUNT(*) FROM camdecmpswks.monitor_plan_reporting_freq UNION ALL
SELECT 'camdecmpswks' AS schema_name, 'monitor_qualification' AS table_name, COUNT(*) FROM camdecmpswks.monitor_qualification UNION ALL
SELECT 'camdecmpswks' AS schema_name, 'monitor_qualification_lee' AS table_name, COUNT(*) FROM camdecmpswks.monitor_qualification_lee UNION ALL
SELECT 'camdecmpswks' AS schema_name, 'monitor_qualification_lme' AS table_name, COUNT(*) FROM camdecmpswks.monitor_qualification_lme UNION ALL
SELECT 'camdecmpswks' AS schema_name, 'monitor_qualification_pct' AS table_name, COUNT(*) FROM camdecmpswks.monitor_qualification_pct UNION ALL
SELECT 'camdecmpswks' AS schema_name, 'monitor_span' AS table_name, COUNT(*) FROM camdecmpswks.monitor_span UNION ALL
SELECT 'camdecmpswks' AS schema_name, 'monitor_system' AS table_name, COUNT(*) FROM camdecmpswks.monitor_system UNION ALL
SELECT 'camdecmpswks' AS schema_name, 'monitor_system_component' AS table_name, COUNT(*) FROM camdecmpswks.monitor_system_component UNION ALL
SELECT 'camdecmpswks' AS schema_name, 'on_off_cal' AS table_name, COUNT(*) FROM camdecmpswks.on_off_cal UNION ALL
SELECT 'camdecmpswks' AS schema_name, 'protocol_gas' AS table_name, COUNT(*) FROM camdecmpswks.protocol_gas UNION ALL
SELECT 'camdecmpswks' AS schema_name, 'protocol_gas_vendor' AS table_name, COUNT(*) FROM camdecmpswks.protocol_gas_vendor UNION ALL
SELECT 'camdecmpswks' AS schema_name, 'qa_cert_event' AS table_name, COUNT(*) FROM camdecmpswks.qa_cert_event UNION ALL
SELECT 'camdecmpswks' AS schema_name, 'qa_cert_event_supp_data' AS table_name, COUNT(*) FROM camdecmpswks.qa_cert_event_supp_data UNION ALL
SELECT 'camdecmpswks' AS schema_name, 'qa_supp_attribute' AS table_name, COUNT(*) FROM camdecmpswks.qa_supp_attribute UNION ALL
SELECT 'camdecmpswks' AS schema_name, 'qa_supp_data' AS table_name, COUNT(*) FROM camdecmpswks.qa_supp_data UNION ALL
SELECT 'camdecmpswks' AS schema_name, 'rata' AS table_name, COUNT(*) FROM camdecmpswks.rata UNION ALL
SELECT 'camdecmpswks' AS schema_name, 'rata_run' AS table_name, COUNT(*) FROM camdecmpswks.rata_run UNION ALL
SELECT 'camdecmpswks' AS schema_name, 'rata_summary' AS table_name, COUNT(*) FROM camdecmpswks.rata_summary UNION ALL
SELECT 'camdecmpswks' AS schema_name, 'rata_traverse' AS table_name, COUNT(*) FROM camdecmpswks.rata_traverse UNION ALL
SELECT 'camdecmpswks' AS schema_name, 'rect_duct_waf' AS table_name, COUNT(*) FROM camdecmpswks.rect_duct_waf UNION ALL
SELECT 'camdecmpswks' AS schema_name, 'stack_pipe' AS table_name, COUNT(*) FROM camdecmpswks.stack_pipe UNION ALL
SELECT 'camdecmpswks' AS schema_name, 'system_fuel_flow' AS table_name, COUNT(*) FROM camdecmpswks.system_fuel_flow UNION ALL
SELECT 'camdecmpswks' AS schema_name, 'test_extension_exemption' AS table_name, COUNT(*) FROM camdecmpswks.test_extension_exemption UNION ALL
SELECT 'camdecmpswks' AS schema_name, 'test_qualification' AS table_name, COUNT(*) FROM camdecmpswks.test_qualification UNION ALL
SELECT 'camdecmpswks' AS schema_name, 'test_summary' AS table_name, COUNT(*) FROM camdecmpswks.test_summary UNION ALL
SELECT 'camdecmpswks' AS schema_name, 'trans_accuracy' AS table_name, COUNT(*) FROM camdecmpswks.trans_accuracy UNION ALL
SELECT 'camdecmpswks' AS schema_name, 'unit_capacity' AS table_name, COUNT(*) FROM camdecmpswks.unit_capacity UNION ALL
SELECT 'camdecmpswks' AS schema_name, 'unit_control' AS table_name, COUNT(*) FROM camdecmpswks.unit_control UNION ALL
SELECT 'camdecmpswks' AS schema_name, 'unit_default_test' AS table_name, COUNT(*) FROM camdecmpswks.unit_default_test UNION ALL
SELECT 'camdecmpswks' AS schema_name, 'unit_default_test_run' AS table_name, COUNT(*) FROM camdecmpswks.unit_default_test_run UNION ALL
SELECT 'camdecmpswks' AS schema_name, 'unit_fuel' AS table_name, COUNT(*) FROM camdecmpswks.unit_fuel UNION ALL
SELECT 'camdecmpswks' AS schema_name, 'unit_stack_configuration' AS table_name, COUNT(*) FROM camdecmpswks.unit_stack_configuration UNION ALL
SELECT 'camdecmpswks' AS schema_name, 'user_check_out' AS table_name, COUNT(*) FROM camdecmpswks.user_check_out UNION ALL
SELECT 'camdecmpswks' AS schema_name, 'user_session' AS table_name, COUNT(*) FROM camdecmpswks.user_session UNION ALL
*/
...
SELECT 'camdmd' AS schema_name, 'unit_type_code' AS table_name, COUNT(*) FROM camdmd.unit_type_code --UNION ALL
