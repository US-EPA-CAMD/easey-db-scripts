...
--   UNIT_HISTORY_SS (Materialized View)
--
CREATE UNIQUE INDEX IF NOT EXISTS PK_UNIT_HISTORY ON UNIT_HISTORY_SS
...
--   UNIT_HISTORY_SS (Materialized View)
--
CREATE INDEX IF NOT EXISTS UH_IDX_NEW_ACCT_NUM ON UNIT_HISTORY_SS
(NEW_ACCOUNT_NUMBER)
/
...
--   UNIT_HISTORY_SS (Materialized View)
--
CREATE INDEX IF NOT EXISTS UH_IDX_NEW_FAC_ID ON UNIT_HISTORY_SS
(NEW_FAC_ID)
/
...
--   UNIT_HISTORY_SS (Materialized View)
--
CREATE INDEX IF NOT EXISTS UH_IDX_OLD_ACCT_NUM ON UNIT_HISTORY_SS
(OLD_ACCOUNT_NUMBER)
/
...
--   UNIT_HISTORY_SS (Materialized View)
--
CREATE INDEX IF NOT EXISTS UH_IDX_OLD_FAC_ID ON UNIT_HISTORY_SS
(OLD_FAC_ID)
/
