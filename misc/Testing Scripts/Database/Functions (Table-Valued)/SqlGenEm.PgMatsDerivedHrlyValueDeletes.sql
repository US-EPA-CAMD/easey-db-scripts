...
/****** Object:  UserDefinedFunction [SqlGenEm].[PgMatsDerivedHrlyValueDeletes]    Script Date: 2/8/2023 4:25:57 PM ******/
SET ANSI_NULLS ON
GO
...
CREATE OR ALTER FUNCTION SqlGenEm.PgMatsDerivedHrlyValueDeletes
(	
...
(
    select  SqlGenEm.FormatSql
            (
                ...
                concat
                (
                    'delete from camdecmpswks.MATS_DERIVED_HRLY_VALUE tar',
      ...
      from  (
                select  -- ECMPSP
                    ...
                    from  @TestInformationTable lst
                        ...
                        join [CHV-DWHITTEN2\ECMPSP].ECMPS.dbo.MATS_DERIVED_HRLY_VALUE dhv 
                ...
                select  -- ECMPS_WORKING
                    ...
                    from  @TestInformationTable lst
                        join ECMPS.dbo.HRLY_OP_DATA hod 
                            on hod.MON_LOC_ID = lst.MON_LOC_ID
                            and hod.RPT_PERIOD_ID = lst.RPT_PERIOD_ID
                        join ECMPS.dbo.MATS_DERIVED_HRLY_VALUE dhv 
                            on dhv.HOUR_ID = hod.HOUR_ID
            ) sel
)
GO
