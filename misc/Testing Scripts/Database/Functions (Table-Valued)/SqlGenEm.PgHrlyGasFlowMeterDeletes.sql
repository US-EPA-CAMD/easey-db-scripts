...
/****** Object:  UserDefinedFunction [SqlGenEm].[PgHrlyGasFlowMeterDeletes]    Script Date: 2/11/2023 6:40:13 PM ******/
SET ANSI_NULLS ON
GO
...
CREATE OR ALTER FUNCTION SqlGenEm.PgHrlyGasFlowMeterDeletes
(	
...
(
    select  SqlGenEm.FormatSql
            (
                ...
                concat
                (
                    'delete from camdecmpswks.HRLY_GAS_FLOW_METER tar',
