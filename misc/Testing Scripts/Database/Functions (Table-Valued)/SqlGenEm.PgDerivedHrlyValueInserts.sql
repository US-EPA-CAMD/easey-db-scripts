...
/****** Object:  UserDefinedFunction [SqlGenEm].[PgDerivedHrlyValueInserts]    Script Date: 2/8/2023 2:37:38 PM ******/
SET ANSI_NULLS ON
GO
...
CREATE OR ALTER   FUNCTION SqlGenEm.PgDerivedHrlyValueInserts
(	
            ...
            (
                ...
                (
                    ...
                    ' (',
                        ...
                        case when  tar.DILUENT_CAP_IND                is not null  then  cast( tar.DILUENT_CAP_IND as varchar ) else 'NULL' end, ', ',
