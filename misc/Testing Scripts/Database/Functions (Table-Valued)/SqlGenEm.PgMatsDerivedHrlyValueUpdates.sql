...
/****** Object:  UserDefinedFunction [SqlGenEm].[PgMatsDerivedHrlyValueUpdates]    Script Date: 2/7/2023 1:29:25 PM ******/
SET ANSI_NULLS ON
GO
...
CREATE or ALTER FUNCTION SqlGenEm.PgMatsDerivedHrlyValueUpdates
(	
...
(
    select  SqlGenEm.FormatSql
            (
                ...
                concat
                (
                    'update camdecmpswks.MATS_DERIVED_HRLY_VALUE dhv set',
      ...
      from  (
                  ...
                  from  (
                            select  -- ECMPSP
                              ...
                              from  @TestInformationTable lst
                                    ...
                                    join [CHV-DWHITTEN2\ECMPSP].ECMPS.dbo.MATS_DERIVED_HRLY_VALUE mdh 
                                        on mdh.HOUR_ID = hod.HOUR_ID
                            union
                            select  -- ECMPS_WORKING
                              ...
                              from  @TestInformationTable lst
                                    join ECMPS.dbo.HRLY_OP_DATA hod 
                                      on hod.MON_LOC_ID = lst.MON_LOC_ID
                                     and hod.RPT_PERIOD_ID = lst.RPT_PERIOD_ID
                                    join ECMPS.dbo.MATS_DERIVED_HRLY_VALUE mdh 
                                        on mdh.HOUR_ID = hod.HOUR_ID
                        ) dat
                 group
                    by  dat.ORIS_CODE, 
        ...
        join ECMPS.dbo.MATS_DERIVED_HRLY_VALUE tar 
