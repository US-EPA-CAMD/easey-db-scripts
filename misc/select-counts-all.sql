...
SELECT 'camdecmps' AS schema_name, 'mats_monitor_hour' AS table_name, COUNT(*) FROM camdecmps.mats_monitor_hour UNION ALL
...
SELECT 'camdecmps' AS schema_name, 'mats_unit_hour' AS table_name, COUNT(*) FROM camdecmps.mats_unit_hour UNION ALL
SELECT 'camdecmps' AS schema_name, 'monitor_day' AS table_name, COUNT(*) FROM camdecmps.monitor_day UNION ALL
...
SELECT 'camdecmps' AS schema_name, 'monitor_hour' AS table_name, COUNT(*) FROM camdecmps.monitor_hour UNION ALL
...
SELECT 'camdecmps' AS schema_name, 'monitor_month' AS table_name, COUNT(*) FROM camdecmps.monitor_month UNION ALL
...
SELECT 'camdecmps' AS schema_name, 'monitor_quarter' AS table_name, COUNT(*) FROM camdecmps.monitor_quarter UNION ALL
...
SELECT 'camdecmps' AS schema_name, 'unit_day' AS table_name, COUNT(*) FROM camdecmps.unit_day UNION ALL
...
SELECT 'camdecmps' AS schema_name, 'unit_hour' AS table_name, COUNT(*) FROM camdecmps.unit_hour UNION ALL
SELECT 'camdecmps' AS schema_name, 'unit_month' AS table_name, COUNT(*) FROM camdecmps.unit_month UNION ALL
SELECT 'camdecmps' AS schema_name, 'unit_quarter' AS table_name, COUNT(*) FROM camdecmps.unit_quarter UNION ALL
