...
-- DROP TABLE IF EXISTS camdecmpswks.daily_test_summary;
...
-- DROP INDEX IF EXISTS camdecmpswks.daily_test_summary_idx002;
...
-- DROP INDEX IF EXISTS camdecmpswks.idx_daily_test_summ_calc_test;
...
-- DROP INDEX IF EXISTS camdecmpswks.idx_daily_test_summ_component;
...
-- DROP INDEX IF EXISTS camdecmpswks.idx_daily_test_summ_mon_loc_id;
...
-- DROP INDEX IF EXISTS camdecmpswks.idx_daily_test_summ_span_scale;
...
-- DROP INDEX IF EXISTS camdecmpswks.idx_daily_test_summ_test_resul;
...
-- DROP INDEX IF EXISTS camdecmpswks.idx_daily_test_summ_test_type;
...
-- DROP INDEX IF EXISTS camdecmpswks.idx_daily_test_summary_01;
...
-- DROP INDEX IF EXISTS camdecmpswks.idx_dts_add_date;
