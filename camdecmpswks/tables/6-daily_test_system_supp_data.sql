-- Table: camdecmpswks.daily_test_system_supp_data

-- DROP TABLE IF EXISTS camdecmpswks.daily_test_system_supp_data;

CREATE TABLE IF NOT EXISTS camdecmpswks.daily_test_system_supp_data
(
...
COMMENT ON TABLE camdecmpswks.daily_test_system_supp_data
    IS '.';

COMMENT ON COLUMN camdecmpswks.daily_test_system_supp_data.daily_test_system_supp_data_id
    IS 'Unique identifier.';

COMMENT ON COLUMN camdecmpswks.daily_test_system_supp_data.mon_sys_id
    IS '.';

COMMENT ON COLUMN camdecmpswks.daily_test_system_supp_data.op_hour_cnt
    IS 'Count of hours in the quarter for the component and operating supplemental data type.';

COMMENT ON COLUMN camdecmpswks.daily_test_system_supp_data.last_covered_nonop_datehour
    IS '.';

COMMENT ON COLUMN camdecmpswks.daily_test_system_supp_data.mon_loc_id
    IS 'Unique identifier of a monitoring location record.';

COMMENT ON COLUMN camdecmpswks.daily_test_system_supp_data.rpt_period_id
    IS 'Unique identifier of a report period.';

COMMENT ON COLUMN camdecmpswks.daily_test_system_supp_data.userid
    IS 'User account or source of data that added or updated record.';

COMMENT ON COLUMN camdecmpswks.daily_test_system_supp_data.add_date
    IS 'Date and time in which record was added.';

COMMENT ON COLUMN camdecmpswks.daily_test_system_supp_data.update_date
    IS 'Date and time in which record was last updated.';

-- Index: idx_daily_test_sys_sup_data_dt

-- DROP INDEX IF EXISTS camdecmpswks.idx_daily_test_sys_sup_data_dt;
...
-- DROP INDEX IF EXISTS camdecmpswks.idx_daily_test_sys_sup_data_em;
...
-- DROP INDEX IF EXISTS camdecmpswks.idx_daily_test_sys_sup_data_ml;
...
-- DROP INDEX IF EXISTS camdecmpswks.idx_daily_test_sys_sup_data_ms;
...
-- DROP INDEX IF EXISTS camdecmpswks.idx_daily_test_sys_sup_data_rp;
