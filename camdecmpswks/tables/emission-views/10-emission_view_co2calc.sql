...
(
    ...
    CONSTRAINT pk_emission_view_co2calc PRIMARY KEY (mon_plan_id, mon_loc_id, rpt_period_id, date_hour),
    CONSTRAINT fk_emission_view_co2calc_emission_evaluation FOREIGN KEY (rpt_period_id, mon_plan_id)
    ...
    CONSTRAINT fk_emission_view_co2calc_monitor_plan FOREIGN KEY (mon_plan_id)
        ...
        ON UPDATE NO ACTION
        ON DELETE NO ACTION,
    CONSTRAINT fk_emission_view_co2calc_reporting_period FOREIGN KEY (rpt_period_id)
