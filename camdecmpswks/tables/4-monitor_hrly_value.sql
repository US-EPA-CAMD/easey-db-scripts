...
-- DROP TABLE IF EXISTS camdecmpswks.monitor_hrly_value;
...
-- DROP INDEX IF EXISTS camdecmpswks.idx_mhv_add_date;
...
-- DROP INDEX IF EXISTS camdecmpswks.idx_mon_hrly_param1;
...
-- DROP INDEX IF EXISTS camdecmpswks.idx_mon_hrly_param2;
...
-- DROP INDEX IF EXISTS camdecmpswks.idx_monitor_hrly_va_component;
...
-- DROP INDEX IF EXISTS camdecmpswks.idx_monitor_hrly_va_mon_sys_id;
...
-- DROP INDEX IF EXISTS camdecmpswks.idx_monitor_hrly_va_parameter_;
...
-- DROP INDEX IF EXISTS camdecmpswks.monitor_hrly_value_idx003;
