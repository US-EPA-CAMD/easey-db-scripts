...
(
    em_so2_appd_id integer NOT NULL GENERATED ALWAYS AS IDENTITY ( INCREMENT 1 START 1 MINVALUE 1 MAXVALUE 2147483647 CACHE 1 ),
    ...
    CONSTRAINT pk_emission_view_so2appd PRIMARY KEY (em_so2_appd_id),
