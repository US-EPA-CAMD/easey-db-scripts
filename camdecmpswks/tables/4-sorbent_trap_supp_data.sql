-- Table: camdecmpswks.sorbent_trap_supp_data

-- DROP TABLE IF EXISTS camdecmpswks.sorbent_trap_supp_data;
...
-- DROP INDEX IF EXISTS camdecmpswks.idx_st_supp_data_emr;

CREATE INDEX IF NOT EXISTS IF NOT EXISTS idx_st_supp_data_emr
    ON camdecmpswks.sorbent_trap_supp_data USING btree
    (rpt_period_id ASC NULLS LAST, mon_loc_id COLLATE pg_catalog."default" ASC NULLS LAST);

-- Index: idx_st_supp_data_modc

-- DROP INDEX IF EXISTS camdecmpswks.idx_st_supp_data_modc;
...
-- DROP INDEX IF EXISTS camdecmpswks.idx_st_supp_data_mon_loc_id;
...
-- DROP INDEX IF EXISTS camdecmpswks.idx_st_supp_data_mon_sys_id;
...
-- DROP INDEX IF EXISTS camdecmpswks.st_supp_data_idx001;
