...
SELECT
    ...
    CASE
        ...
        ELSE usc.begin_date
    END AS emissions_recording_begin_date, up.trueup_begin_year, up.unit_monitor_cert_deadline, up.non_egu_ind, up.app_status_cd,up.optin_ind, up.def_ind, up.def_end_date,
    CASE
...
UNION
SELECT
    up.up_id, ml.mon_plan_id, ml.mon_loc_id, ml.oris_code, ml.location_name, ml.unit_id, NULL AS stack_pipe_id, up.prg_cd, up.class_cd, up.unit_monitor_cert_begin_date, up.emissions_recording_begin_date, up.trueup_begin_year, up.unit_monitor_cert_deadline, up.non_egu_ind, up.app_status_cd, up.optin_ind, up.def_ind, up.def_end_date, up.end_date, ml.fac_id
    FROM camdecmpswks.vw_mp_monitor_location AS ml
    INNER JOIN camd.unit_program AS up
