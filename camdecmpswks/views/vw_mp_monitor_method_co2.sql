-- View: camdecmpswks.vw_mp_monitor_method_co2

DROP VIEW IF EXISTS camdecmpswks.vw_mp_monitor_method_co2;

CREATE OR REPLACE VIEW camdecmpswks.vw_mp_monitor_method_co2
 AS
 SELECT monitor_method.mon_method_id,
  ...
  WHERE monitor_method.parameter_cd::text = ANY (ARRAY['CO2'::character varying::text, 'CO2M'::character varying::text]);
