-- View: camdecmpswks.vw_mp_monitor_method_h2o

DROP VIEW IF EXISTS camdecmpswks.vw_mp_monitor_method_h2o;

CREATE OR REPLACE VIEW camdecmpswks.vw_mp_monitor_method_h2o
 AS
 SELECT monitor_method.mon_method_id,
  ...
  WHERE monitor_method.parameter_cd::text = 'H2O'::text;
