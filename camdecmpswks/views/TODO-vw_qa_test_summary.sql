...
SELECT
    ...
    --TODO: discuss this
    FROM camdecmps.test_summary AS ts
    ...
    LEFT OUTER JOIN camdecmps.fuel_flowmeter_accuracy AS ff
        ON ts.test_sum_id = ff.test_sum_id
    LEFT OUTER JOIN camdecmps.unit_default_test AS udt
    ...
    LEFT OUTER JOIN camdecmps.flow_to_load_check AS flc
        ON ts.test_sum_id = flc.test_sum_id
    LEFT OUTER JOIN camdecmps.flow_to_load_reference AS flr
