...
SELECT
    mpl.mon_plan_id, mpl.mon_loc_id, uf.uf_id, u.unitid AS location_name, u.unitid AS unit_name, uf.dem_gcv, uf.dem_so2, uf.begin_date, uf.end_date, uf.indicator_cd, uf.ozone_seas_ind, uf.fuel_type, fc.fuel_group_cd, uf.unit_id
    ...
    INNER JOIN camdecmpsmd.fuel_code AS fc
        ON uf.fuel_type = fc.fuel_cd
UNION
SELECT
    mpl.mon_plan_id, mpl.mon_loc_id, uf.uf_id, camdecmpswks.stack_pipe.stack_name AS location_name, u.unitid AS unit_name, uf.dem_gcv, uf.dem_so2, uf.begin_date, uf.end_date, uf.indicator_cd, uf.ozone_seas_ind, uf.fuel_type, fc.fuel_group_cd, uf.unit_id
    FROM camdecmpswks.monitor_plan_location AS mpl
    INNER JOIN camdecmpswks.monitor_location AS ml
        ON mpl.mon_loc_id = ml.mon_loc_id
