CREATE OR REPLACE VIEW camdecmpswks.vw_mp_monitor_method_hi (mon_method_id, mon_plan_id, mon_loc_id, parameter_cd, sub_data_cd, bypass_approach_cd, method_cd, begin_date, begin_hour, end_date, end_hour) AS
SELECT
    ...
    WHERE (LOWER(monitor_method.parameter_cd) LIKE LOWER('HI%'));