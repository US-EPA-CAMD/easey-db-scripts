-- View: camdecmpswks.vw_rule_check

-- DROP VIEW camdecmpswks.vw_rule_check;

CREATE OR REPLACE VIEW camdecmpswks.vw_rule_check
 AS
 SELECT rc.rule_check_id,
   ...
   FROM camdecmpsmd.rule_check rc
     ...
     LEFT JOIN camdecmpswks.vw_check_status_code chk_stat ON cc.check_status_cd::text = chk_stat.check_status_cd::text
