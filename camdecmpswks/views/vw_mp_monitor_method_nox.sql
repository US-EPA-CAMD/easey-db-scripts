-- View: camdecmpswks.vw_mp_monitor_method_nox

DROP VIEW IF EXISTS camdecmpswks.vw_mp_monitor_method_nox;

CREATE OR REPLACE VIEW camdecmpswks.vw_mp_monitor_method_nox
 AS
 SELECT monitor_method.mon_method_id,
  ...
  WHERE monitor_method.parameter_cd::text = ANY (ARRAY['NOX'::character varying::text, 'NOXM'::character varying::text]);
