...
BEGIN  
    ...
    RETURN QUERY    
        select  mpl.MON_LOC_ID,
                ...
                )::numeric as HRLY_VALUE,
                (
                    case 
                        when xrf.PRIMARY_BYPASS_IND = 1 and
                             exists ( 
                                        select  1
          ...
          from  camdecmpswks.MONITOR_PLAN_LOCATION mpl
                ...
                join camdecmpswks.LAST_QA_VALUE_SUPP_DATA sup
                  on sup.MON_LOC_ID = mpl.MON_LOC_ID 
                 and sup.RPT_PERIOD_ID = prd.RPT_PERIOD_ID
                 and sup.MON_SYS_ID is null
