-- FUNCTION: camdecmpswks.rpt_mp_formula(character varying)

DROP FUNCTION IF EXISTS camdecmpswks.rpt_mp_formula(character varying) CASCADE;
...
SELECT
		...
		camdecmpswks.format_date_hour(mf.begin_date, mf.begin_hour, null) AS "beginDateHour",
		camdecmpswks.format_date_hour(mf.end_date, mf.end_hour, null) AS "endDateHour"
