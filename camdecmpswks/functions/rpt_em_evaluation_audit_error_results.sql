...
DROP FUNCTION IF EXISTS camdecmpswks.rpt_em_evaluation_audit_error_results(text, numeric, numeric) CASCADE;
...
SELECT DISTINCT
	...
	cl.severity_cd <> 'NONE' AND ccd.process_cd = 'HOURLY' AND cc.check_type_cd = 'EMAUDIT';
$BODY$;
