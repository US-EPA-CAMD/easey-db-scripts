...
--------------------------------------------------------------------------------
*/
DROP FUNCTION IF EXISTS camdecmpswks.get_monitor_hourly_values_pivoted(text, numeric, text[], text[], text[]);
DROP FUNCTION IF EXISTS camdecmpswks.get_monitor_hourly_values_pivoted(character varying, numeric, text[]);

CREATE OR REPLACE FUNCTION camdecmpswks.get_monitor_hourly_values_pivoted(
...
DROP FUNCTION IF EXISTS camdecmpswks.get_monitor_hourly_values_pivoted(text, numeric, text[]);
...
BEGIN
	...
	sqlText := format('
		SELECT * FROM camdecmpswks.get_monitor_hourly_values_pivoted(
...
--------------------------------------------------------------------------------
SELECT *
FROM camdecmpswks.get_monitor_hourly_values_pivoted(
