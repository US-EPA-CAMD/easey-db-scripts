...
DROP FUNCTION IF EXISTS camdecmpswks.emissions_get_default_so2_rate(character varying, timestamp without time zone, integer) CASCADE;
...
DROP FUNCTION IF EXISTS camdecmpswks.emissions_get_default_so2_rate(character varying, timestamp without time zone, numeric) CASCADE;
