-- FUNCTION: camdecmpswks.rpt_qa_hg_linearity_statistics(text)

DROP FUNCTION IF EXISTS camdecmpswks.rpt_qa_hg_linearity_statistics(text) CASCADE;

CREATE OR REPLACE FUNCTION camdecmpswks.rpt_qa_hg_linearity_statistics(
	testsumid text)
