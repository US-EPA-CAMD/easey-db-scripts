DROP FUNCTION IF EXISTS camdecmpswks.rpt_qa_ae_hi_oil(text) CASCADE;

CREATE OR REPLACE FUNCTION camdecmpswks.rpt_qa_ae_hi_oil(
	testsumid text)
...
SELECT
	...
	FROM camdecmpswks.ae_hi_oil o
	join camdecmpswks.ae_correlation_test_run tr using(ae_corr_test_run_id)
