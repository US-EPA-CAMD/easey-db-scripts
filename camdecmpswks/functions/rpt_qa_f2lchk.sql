DROP FUNCTION IF EXISTS camdecmpswks.rpt_qa_fl2chk(text) CASCADE;

CREATE OR REPLACE FUNCTION camdecmpswks.rpt_qa_fl2chk(
	testsumid text)
...
SELECT
	...
	FROM camdecmpswks.flow_to_load_check chk
