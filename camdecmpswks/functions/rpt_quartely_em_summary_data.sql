-- FUNCTION: camdecmpswks.rpt_quartely_em_summary_data(text, numeric)

DROP FUNCTION IF EXISTS camdecmpswks.rpt_quartely_em_summary_data(text, numeric) CASCADE;
    ...
    (with lst as
        ...
        from  (
                    ...
                    from  (
                                ...
                                from  lst
                                        join camdecmpswks.operating_supp_data osd
                            ...
                            left join camdecmpswks.operating_supp_data osd
                                ...
                                case
                                    ...
                                    (
                                        select  (
                                                    ...
                                                    from  camdecmpswks.operating_supp_data osd_sub
                    ...
                    from  lst
                            ...
                            and  osd.fuel_cd is null
                            join camdecmpswks.monitor_plan_reporting_freq frq
