...
-- DROP FUNCTION camdecmpswks.rpt_em_monitor_hourly_value(text, numeric, numeric);
...
ALTER FUNCTION camdecmpswks.rpt_em_monitor_hourly_value(text, numeric, numeric)
