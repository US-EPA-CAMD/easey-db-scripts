...
-- DROP FUNCTION camdecmpswks.rpt_em_mats_derived_hourly_value(text, numeric, numeric);
...
ALTER FUNCTION camdecmpswks.rpt_em_mats_derived_hourly_value(text, numeric, numeric)
