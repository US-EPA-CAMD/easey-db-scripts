-- FUNCTION: camdecmpswks.rpt_mp_method(character varying)

DROP FUNCTION IF EXISTS camdecmpswks.rpt_mp_method(character varying) CASCADE;
...
SELECT
		...
		camdecmpswks.format_date_hour(mm.begin_date, mm.begin_hour, null) AS "beginDateHour",
		camdecmpswks.format_date_hour(mm.end_date, mm.end_hour, null) AS "endDateHour"
