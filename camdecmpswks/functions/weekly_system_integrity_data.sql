...
BEGIN  
    RETURN QUERY
        select	coalesce(unt.UNITID, stp.STACK_NAME) LOCATION_NAME,
                ...
                camdecmpswks.DATE_ADD( 'minute', wts.TEST_MIN, camdecmpswks.DATE_ADD( 'hour', wts.TEST_HOUR, wts.TEST_DATE) ) as TEST_DATETIME,
                wts.SPAN_SCALE_CD,
                wts.TEST_RESULT_CD,
                ...
                camdecmpswks.DATE_ADD( 'hour', wts.TEST_HOUR, wts.TEST_DATE) as TEST_DATEHOUR,
                wts.TEST_DATE,
                wts.TEST_HOUR,
                wts.TEST_MIN,
                case 
