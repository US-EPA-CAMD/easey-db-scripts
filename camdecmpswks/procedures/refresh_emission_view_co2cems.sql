...
BEGIN
	...
	INNER JOIN camdecmpswks.MONITOR_HRLY_VALUE AS FLOW_MHV
	...
	LEFT JOIN camdecmpswks.DERIVED_HRLY_VALUE AS CO2M_DHV 
	...
	LEFT JOIN camdecmpswks.DERIVED_HRLY_VALUE AS CO2C_DHV
	...
	LEFT JOIN camdecmpswks.MONITOR_HRLY_VALUE AS CO2C_MHV
	...
	LEFT JOIN camdecmpswks.MONITOR_HRLY_VALUE AS H2O_MHV
	...
	LEFT JOIN camdecmpswks.DERIVED_HRLY_VALUE AS H2O_DHV
