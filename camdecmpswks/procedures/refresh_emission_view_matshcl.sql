-- PROCEDURE: camdecmpswks.refresh_emission_view_matshcl(character varying, numeric)

DROP PROCEDURE IF EXISTS camdecmpswks.refresh_emission_view_matshcl(character varying, numeric);
...
BEGIN
	...
	INNER JOIN camdecmpswks.MATS_DERIVED_HRLY_VALUE AS DHV 
		ON DHV.HOUR_ID = HOD.HOUR_ID AND DHV.PARAMETER_CD IN ( 'HCLRE', 'HCLRH' )
