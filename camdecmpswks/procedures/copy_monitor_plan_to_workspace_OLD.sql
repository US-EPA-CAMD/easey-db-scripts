-- PROCEDURE: camdecmpswks.copy_monitor_plan_to_workspace_old(text)

-- DROP PROCEDURE camdecmpswks.copy_monitor_plan_to_workspace_old(text);

CREATE OR REPLACE PROCEDURE camdecmpswks.copy_monitor_plan_to_workspace_old(
	monplanid text)
LANGUAGE 'plpgsql'
AS $BODY$
BEGIN
