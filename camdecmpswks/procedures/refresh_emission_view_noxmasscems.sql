...
BEGIN
	...
	INSERT INTO camdecmpswks.EMISSION_VIEW_NOXMASSCEMS
		...
		SELECT DISTINCT
				...
				MF.EQUATION_CD AS NOXMASS_FORMULA_CD,
		...
		FROM temp_hourly_errors HOD 
				...
				LEFT OUTER JOIN camdecmpswks.MONITOR_HRLY_VALUE  NOXC_MHV ON DHV.HOUR_ID = NOXC_MHV.HOUR_ID AND NOXC_MHV.PARAMETER_CD = 'NOXC'
				LEFT OUTER JOIN camdecmpswks.MONITOR_HRLY_VALUE  H2O_MHV ON DHV.HOUR_ID = H2O_MHV.HOUR_ID AND H2O_MHV.PARAMETER_CD = 'H2O' 
				...
				LEFT OUTER JOIN camdecmpswks.DERIVED_HRLY_VALUE  NOXR_DHV ON DHV.HOUR_ID = NOXR_DHV.HOUR_ID AND NOXR_DHV.PARAMETER_CD = 'NOXR';
END
$BODY$;
