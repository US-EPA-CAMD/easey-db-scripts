CREATE OR REPLACE PROCEDURE camdecmpswks.refresh_emission_view_matssorbent
(
...
BEGIN
    ...
    INSERT
      INTO  camdecmpswks.EMISSION_VIEW_MATSSORBENT
      ...
      FROM  (
                SELECT  sel.Mon_Plan_Id,
                        ...
                        camdecmpswks.FORMAT_DATE_HOUR( trp.Begin_Date, trp.Begin_Hour, null ) AS Date_Hour,
                        camdecmpswks.FORMAT_DATE_HOUR( trp.End_Date, trp.End_Hour, null ) AS End_Date_Hour,
                            ...
                            SELECT  trn.Trap_Train_Id
                              FROM  (
                                        SELECT  sbt.Trap_Id,
                                          ...
                                          FROM  camdecmpswks.SAMPLING_TRAIN sbt
                                                JOIN camdecmpswks.COMPONENT sbc
