...
BEGIN
	...
	LEFT OUTER JOIN camdecmpswks.DERIVED_HRLY_VALUE AS HIT_DHV 
		ON HOD.HOUR_ID = HIT_DHV.HOUR_ID AND HIT_DHV.PARAMETER_CD = 'HIT'
	LEFT OUTER JOIN camdecmpswks.DERIVED_HRLY_VALUE AS SO2M_DHV 
		ON HOD.HOUR_ID = SO2M_DHV.HOUR_ID AND SO2M_DHV.PARAMETER_CD = 'SO2M'
	LEFT OUTER JOIN camdecmpswks.MONITOR_DEFAULT as SO2R_MD 
		ON HOD.MON_LOC_ID = SO2R_MD.MON_LOC_ID AND 
		camdecmpswks.emissions_monitor_default_active(SO2R_MD.BEGIN_DATE, SO2R_MD.BEGIN_HOUR, SO2R_MD.END_DATE, SO2R_MD.END_HOUR, HOD.BEGIN_DATE, HOD.BEGIN_HOUR) = 1 
	...
	LEFT OUTER JOIN camdecmpswks.DERIVED_HRLY_VALUE AS NOXM_DHV 
	...
	LEFT OUTER JOIN camdecmpswks.DERIVED_HRLY_VALUE as CO2M_DHV 
		ON HOD.HOUR_ID = CO2M_DHV.HOUR_ID AND CO2M_DHV.PARAMETER_CD = 'CO2M'
	LEFT OUTER JOIN camdecmpswks.MONITOR_DEFAULT AS CO2R_MD 
		ON HOD.MON_LOC_ID = CO2R_MD.MON_LOC_ID AND 
		camdecmpswks.emissions_monitor_default_active(CO2R_MD.BEGIN_DATE, CO2R_MD.BEGIN_HOUR, CO2R_MD.END_DATE, CO2R_MD.END_HOUR, HOD.BEGIN_DATE, HOD.BEGIN_HOUR) = 1 
