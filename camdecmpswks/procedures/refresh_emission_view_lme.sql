...
BEGIN
	...
	LEFT JOIN camdecmpswks.DERIVED_HRLY_VALUE AS HIT_DHV 
	...
	LEFT JOIN camdecmpswks.DERIVED_HRLY_VALUE AS SO2M_DHV 
	...
	LEFT JOIN camdecmpswks.DERIVED_HRLY_VALUE AS NOXM_DHV 
