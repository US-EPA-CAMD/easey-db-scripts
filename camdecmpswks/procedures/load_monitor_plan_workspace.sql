...
BEGIN
		...
		FROM camdecmpswks.stack_pipe AS sp;
		...
		FROM camdecmpswks.component AS c;
		...
		FROM camdecmpswks.mats_method_data AS mmd;
		...
		FROM camdecmpswks.monitor_formula AS mf;
		...
		FROM camdecmpswks.monitor_location_attribute AS mla;
		...
		FROM camdecmpswks.monitor_method AS mm;
		...
		FROM camdecmpswks.monitor_qualification AS mq;
		...
		FROM camdecmpswks.monitor_system AS ms;
		...
		FROM camdecmpswks.rect_duct_waf AS rdw;
		...
		FROM camdecmpswks.unit_control AS uc;
		...
		FROM camdecmpswks.unit_fuel AS uf;
		...
		FROM camdecmpswks.unit_stack_configuration AS usc;		
END;
$BODY$;
