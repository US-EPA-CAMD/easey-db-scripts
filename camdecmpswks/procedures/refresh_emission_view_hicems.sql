...
BEGIN
  ...
  RAISE NOTICE 'Refreshing view data...';
	...
	JOIN camdecmpswks.MONITOR_HRLY_VALUE AS MHV 
	...
	LEFT JOIN camdecmpswks.MONITOR_HRLY_VALUE AS MHV_CO2C
	...
	LEFT JOIN camdecmpswks.MONITOR_HRLY_VALUE AS MHV_CO2C_2
	...
	LEFT JOIN camdecmpswks.MONITOR_HRLY_VALUE AS MHV_O2C_DRY 
	...
	LEFT JOIN camdecmpswks.MONITOR_HRLY_VALUE AS MHV_O2C_DRY_2 
	...
	LEFT JOIN camdecmpswks.MONITOR_HRLY_VALUE AS MHV_O2C_WET 
	...
	LEFT JOIN camdecmpswks.MONITOR_HRLY_VALUE AS MHV_O2C_WET_2 
