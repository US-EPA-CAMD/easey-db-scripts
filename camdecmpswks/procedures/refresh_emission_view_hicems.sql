...
BEGIN
	...
	INSERT INTO camdecmpswks.EMISSION_VIEW_HICEMS
		...
		FROM camdecmpswks.temp_hourly_errors AS HOD 
				...
				LEFT OUTER JOIN camdecmpswks.MONITOR_DEFAULT AS H2O_MD ON HOD.MON_LOC_ID = H2O_MD.MON_LOC_ID AND H2O_MD.DEFAULT_PURPOSE_CD = 'PM' AND H2O_MD.PARAMETER_CD = 'H2O' AND (camdecmpswks.fn_CLIENT_EMISSIONS_MONITOR_DEFAULT_ACTIVE(H2O_MD.BEGIN_DATE, H2O_MD.BEGIN_HOUR, H2O_MD.END_DATE, H2O_MD.END_HOUR, HOD.BEGIN_DATE, HOD.BEGIN_HOUR) = 1)
