...
BEGIN
	...
	INSERT INTO camdecmpswks.EMISSION_VIEW_MATSHF
		...
		FROM temp_hourly_errors AS HOD 
				INNER JOIN camdecmpswks.MATS_MONITOR_HRLY_VALUE AS MHV ON MHV.HOUR_ID = HOD.HOUR_ID AND MHV.PARAMETER_CD = 'HFC'
				INNER JOIN camdecmpswks.MATS_DERIVED_HRLY_VALUE AS DHV ON DHV.HOUR_ID = HOD.HOUR_ID AND DHV.PARAMETER_CD IN ( 'HFRE', 'HFRH' ) 
