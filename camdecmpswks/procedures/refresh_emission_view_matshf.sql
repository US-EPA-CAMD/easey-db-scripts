-- PROCEDURE: camdecmpswks.refresh_emission_view_matshf(character varying, numeric)

DROP PROCEDURE IF EXISTS camdecmpswks.refresh_emission_view_matshf(character varying, numeric);
...
BEGIN
	...
	INNER JOIN camdecmpswks.MATS_MONITOR_HRLY_VALUE AS MHV 
		ON MHV.HOUR_ID = HOD.HOUR_ID AND MHV.PARAMETER_CD = 'HFC'
	INNER JOIN camdecmpswks.MATS_DERIVED_HRLY_VALUE AS DHV 
		ON DHV.HOUR_ID = HOD.HOUR_ID AND DHV.PARAMETER_CD IN ( 'HFRE', 'HFRH' ) 
