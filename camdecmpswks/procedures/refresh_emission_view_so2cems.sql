...
BEGIN
	...
	INSERT INTO camdecmpswks.EMISSION_VIEW_SO2CEMS
		...
		FROM temp_hourly_errors HOD 
				INNER JOIN camdecmpswks.DERIVED_HRLY_VALUE  DHV ON DHV.HOUR_ID = HOD.HOUR_ID AND DHV.PARAMETER_CD = 'SO2' 
				INNER JOIN camdecmpswks.MONITOR_HRLY_VALUE  FLOW_MHV ON HOD.HOUR_ID = FLOW_MHV.HOUR_ID AND FLOW_MHV.PARAMETER_CD = 'FLOW'
				LEFT OUTER JOIN camdecmpswks.MONITOR_HRLY_VALUE  SO2C_MHV ON HOD.HOUR_ID = SO2C_MHV.HOUR_ID AND SO2C_MHV.PARAMETER_CD = 'SO2C' 		 
				LEFT OUTER JOIN camdecmpswks.MONITOR_FORMULA  MF ON DHV.MON_FORM_ID = MF.MON_FORM_ID 
