...
BEGIN
	...
	INNER JOIN camdecmpswks.HRLY_PARAM_FUEL_FLOW HPFF_NOXR 
		ON ((HFF.HRLY_FUEL_FLOW_ID = HPFF_NOXR.HRLY_FUEL_FLOW_ID) AND (HPFF_NOXR.PARAMETER_CD = 'NOXR'))
	...
	LEFT OUTER JOIN camdecmpswks.MONITOR_SYSTEM MS_NOXR 
		ON HPFF_NOXR.MON_SYS_ID = MS_NOXR.MON_SYS_ID
	LEFT OUTER JOIN camdecmpswks.MONITOR_FORMULA NOXR_MF 
