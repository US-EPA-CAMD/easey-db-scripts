-- PROCEDURE: camdecmpswks.load_emissions_workspace()

DROP PROCEDURE IF EXISTS camdecmpswks.load_emissions_workspace();

CREATE OR REPLACE PROCEDURE camdecmpswks.load_emissions_workspace(
	)
LANGUAGE 'plpgsql'
AS $BODY$
BEGIN
...
-- PROCEDURE: camdecmpswks.load_emissions_workspace(character varying, numeric, numeric)

DROP PROCEDURE IF EXISTS camdecmpswks.load_emissions_workspace(character varying, numeric, numeric);
