ALTER TABLE IF EXISTS camdecmpswks.sampling_train_supp_data
    ADD CONSTRAINT pk_sampling_train_sd PRIMARY KEY (trap_train_id),
    ADD CONSTRAINT fk_sampling_train_sd_prd FOREIGN KEY (rpt_period_id)
        REFERENCES camdecmpsmd.reporting_period (rpt_period_id) MATCH SIMPLE,
    ADD CONSTRAINT fk_sampling_train_sd_rrc FOREIGN KEY (sampling_ratio_test_result_cd)
        REFERENCES camdecmpsmd.test_result_code (test_result_cd) MATCH SIMPLE,
    ADD CONSTRAINT fk_sampling_train_sd_tqs FOREIGN KEY (train_qa_status_cd)
