ALTER TABLE IF EXISTS camdecmpswks.emission_view_massoilcalc
    ...
    ADD CONSTRAINT fk_emission_view_massoilcalc_emission_evaluation FOREIGN KEY (rpt_period_id, mon_plan_id)
        ...
        ON DELETE CASCADE,
    ADD CONSTRAINT fk_emission_view_massoilcalc_monitor_location FOREIGN KEY (mon_loc_id)
        REFERENCES camdecmpswks.monitor_location (mon_loc_id) MATCH SIMPLE,
    ADD CONSTRAINT fk_emission_view_massoilcalc_monitor_plan FOREIGN KEY (mon_plan_id)
        REFERENCES camdecmpswks.monitor_plan (mon_plan_id) MATCH SIMPLE,
    ADD CONSTRAINT fk_emission_view_massoilcalc_reporting_period FOREIGN KEY (rpt_period_id)
        REFERENCES camdecmpsmd.reporting_period (rpt_period_id) MATCH SIMPLE;

CREATE INDEX IF NOT EXISTS idx_emission_view_massoilcalc_mon_plan_id
    ON camdecmpswks.emission_view_massoilcalc USING btree
		(mon_plan_id COLLATE pg_catalog."default" ASC NULLS LAST);

CREATE INDEX IF NOT EXISTS idx_emission_view_massoilcalc_mon_loc_id
		ON camdecmpswks.emission_view_massoilcalc USING btree
