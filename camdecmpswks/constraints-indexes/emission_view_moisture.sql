ALTER TABLE IF EXISTS camdecmpswks.emission_view_moisture
...
CREATE INDEX IF NOT EXISTS idx_emission_view_moisture_mon_plan_id
    ON camdecmpswks.emission_view_moisture USING btree
...
CREATE INDEX IF NOT EXISTS idx_emission_view_moisture_date_hour
		ON camdecmpswks.emission_view_moisture USING btree
...
CREATE INDEX IF NOT EXISTS idx_emission_view_moisture_rpt_period_id_mon_plan_id
    ON camdecmpswks.emission_view_moisture USING btree
