ALTER TABLE IF EXISTS camdecmpswks.emission_view_noxratecems
...
CREATE INDEX IF NOT EXISTS idx_emission_view_noxratecems_mon_plan_id
    ON camdecmpswks.emission_view_noxratecems USING btree
...
CREATE INDEX IF NOT EXISTS idx_emission_view_noxratecems_rpt_period_id_mon_plan_id
    ON camdecmpswks.emission_view_noxratecems USING btree
