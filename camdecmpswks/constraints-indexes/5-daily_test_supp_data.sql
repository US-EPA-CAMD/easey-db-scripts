ALTER TABLE IF EXISTS camdecmpswks.daily_test_supp_data
    ...
    ADD CONSTRAINT ck_daily_test_supp_data_ssc CHECK (span_scale_cd::text = ANY (ARRAY['H'::character varying::text, 'L'::character varying::text, 'N'::character varying::text])),
