-- Table: camdmd.program_code

-- DROP TABLE camdmd.program_code;
...
(
    ...
    CONSTRAINT fk_program_code_program_group FOREIGN KEY (prg_group_cd)
...
-- Index: idx_program_code_allow_comp
