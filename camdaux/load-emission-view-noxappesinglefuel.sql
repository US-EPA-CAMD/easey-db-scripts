...
BEGIN
	...
	VALUES(datasetCode, 'EMVIEW', 'NOX Appendix E Individual Fuel Curve View', 11, 'NOX Appendix E Individual Fuel Curve data does not exist for the specified monitor plan and reporting period.');
