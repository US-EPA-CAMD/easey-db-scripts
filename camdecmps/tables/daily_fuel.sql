...
COMMENT ON COLUMN camdecmps.daily_fuel.daily_fuel_id
    IS 'Unique identifier of a daily fuel record.';

COMMENT ON COLUMN camdecmps.daily_fuel.daily_emission_id
    IS 'Unique identifier of a daily emission record.';

COMMENT ON COLUMN camdecmps.daily_fuel.fuel_cd
    IS 'Code used to identify the type of fuel. ';

COMMENT ON COLUMN camdecmps.daily_fuel.daily_fuel_feed
    IS 'Feed rate of fuel.';

COMMENT ON COLUMN camdecmps.daily_fuel.carbon_content_used
    IS 'Amount of carbon burned as a percentage of the daily feed rate';

COMMENT ON COLUMN camdecmps.daily_fuel.fuel_carbon_burned
    IS 'Amount of carbon burned.';

COMMENT ON COLUMN camdecmps.daily_fuel.calc_fuel_carbon_burned
    IS 'Calculated total amount of carbon burned.';

COMMENT ON COLUMN camdecmps.daily_fuel.userid
    IS 'User account or source of data that added or updated record.';

COMMENT ON COLUMN camdecmps.daily_fuel.add_date
    IS 'Date and time in which record was added.';

COMMENT ON COLUMN camdecmps.daily_fuel.update_date
    IS 'Date and time in which record was last updated. ';

COMMENT ON COLUMN camdecmps.daily_fuel.rpt_period_id
