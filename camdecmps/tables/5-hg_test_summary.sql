...
ALTER TABLE camdecmps.hg_test_summary
ADD CONSTRAINT fk_hg_test_sum_gas_level_cd FOREIGN KEY (gas_level_cd) 
...
ALTER TABLE camdecmps.hg_test_summary
ADD CONSTRAINT fk_hg_test_sum_hg_test_sum_id FOREIGN KEY (test_sum_id) 
