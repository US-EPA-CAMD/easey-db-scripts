...
COMMENT ON COLUMN camdecmps.component_op_supp_data.comp_op_supp_data_id
    IS 'Unique identifier.';

COMMENT ON COLUMN camdecmps.component_op_supp_data.component_id
    IS 'Unique identifier of a component record. ';

COMMENT ON COLUMN camdecmps.component_op_supp_data.rpt_period_id
    IS 'Unique identifier of a reporting period record. ';

COMMENT ON COLUMN camdecmps.component_op_supp_data.op_supp_data_type_cd
    IS 'Code used to identify the type of operating supplemental data. ';

COMMENT ON COLUMN camdecmps.component_op_supp_data.days
    IS 'Count of days in the quarter for the component and operating supplemental data type.';

COMMENT ON COLUMN camdecmps.component_op_supp_data.hours
    IS 'Count of hours in the quarter for the component and operating supplemental data type.';

COMMENT ON COLUMN camdecmps.component_op_supp_data.mon_loc_id
    IS 'Unique identifier of a monitoring location record. ';

COMMENT ON COLUMN camdecmps.component_op_supp_data.delete_ind
...
COMMENT ON COLUMN camdecmps.component_op_supp_data.userid
    IS 'User account or source of data that added or updated record.';

COMMENT ON COLUMN camdecmps.component_op_supp_data.add_date
