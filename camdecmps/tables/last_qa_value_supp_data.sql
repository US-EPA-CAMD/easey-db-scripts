...
COMMENT ON COLUMN camdecmps.last_qa_value_supp_data.last_qa_value_supp_data_id
    IS 'Unique identifier.';

COMMENT ON COLUMN camdecmps.last_qa_value_supp_data.mon_loc_id
    IS 'Unique identifier of a monitoring location record.';

COMMENT ON COLUMN camdecmps.last_qa_value_supp_data.rpt_period_id
    IS 'Unique identifier of a reporting period record.';

COMMENT ON COLUMN camdecmps.last_qa_value_supp_data.parameter_cd
    IS 'Code used to identify the parameter.';

COMMENT ON COLUMN camdecmps.last_qa_value_supp_data.moisture_basis
    IS 'Moisture basis for measured value.';

COMMENT ON COLUMN camdecmps.last_qa_value_supp_data.hourly_type_cd
    IS 'Code used to identify whether the value is monitored or derived.';

COMMENT ON COLUMN camdecmps.last_qa_value_supp_data.mon_sys_id
    IS 'Unique identifier of a monitor system record. ';

COMMENT ON COLUMN camdecmps.last_qa_value_supp_data.component_id
    IS 'Unique identifier of a component record. ';

COMMENT ON COLUMN camdecmps.last_qa_value_supp_data.op_datehour
    IS 'The operating date and hour of the last quality assured hour. ';

COMMENT ON COLUMN camdecmps.last_qa_value_supp_data.unadjusted_hrly_value
    IS 'Unadjusted value for the last quality assured hour.';

COMMENT ON COLUMN camdecmps.last_qa_value_supp_data.adjusted_hrly_value
    IS 'Adjusted value for the last quality assured hour.';

COMMENT ON COLUMN camdecmps.last_qa_value_supp_data.delete_ind
...
COMMENT ON COLUMN camdecmps.last_qa_value_supp_data.userid
    IS 'User account or source of data that added or updated record.';

COMMENT ON COLUMN camdecmps.last_qa_value_supp_data.add_date
