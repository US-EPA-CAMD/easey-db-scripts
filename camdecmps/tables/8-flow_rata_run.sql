...
ON camdecmps.flow_rata_run
USING BTREE (rata_run_id ASC);
...
ALTER TABLE camdecmps.flow_rata_run
ADD CONSTRAINT fk_rata_run_flow_rata_run FOREIGN KEY (rata_run_id) 
REFERENCES camdecmps.rata_run (rata_run_id)
ON DELETE NO ACTION;
