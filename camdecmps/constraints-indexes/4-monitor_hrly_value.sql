ALTER TABLE IF EXISTS camdecmps.monitor_hrly_value
    ADD CONSTRAINT pk_monitor_hrly_value PRIMARY KEY (rpt_period_id, monitor_hrly_val_id),
    ADD CONSTRAINT fk_monitor_hrly_value_component FOREIGN KEY (component_id)
        REFERENCES camdecmps.component (component_id) MATCH SIMPLE
        ON DELETE CASCADE,
    ADD CONSTRAINT fk_monitor_hrly_value_hrly_op_data FOREIGN KEY (rpt_period_id, hour_id)
