-- FUNCTION: camdecmps.get_mp_location_list(character varying)

DROP FUNCTION IF EXISTS camdecmps.get_mp_location_list(character varying) CASCADE;

CREATE OR REPLACE FUNCTION camdecmps.get_mp_location_list(
