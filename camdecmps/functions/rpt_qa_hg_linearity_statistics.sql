-- FUNCTION: camdecmps.rpt_qa_hg_linearity_statistics(text)

DROP FUNCTION IF EXISTS camdecmps.rpt_qa_hg_linearity_statistics(text) CASCADE;

CREATE OR REPLACE FUNCTION camdecmps.rpt_qa_hg_linearity_statistics(
	testsumid text)
