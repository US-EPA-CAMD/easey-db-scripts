-- FUNCTION: camdecmps.rpt_qa_linearity_injection(text)

DROP FUNCTION IF EXISTS camdecmps.rpt_qa_linearity_injection(text);

CREATE OR REPLACE FUNCTION camdecmps.rpt_qa_linearity_injection(
	testsumid text
)
RETURNS TABLE(
	"unitStack" text,	
