...
--------------------------------------------------------------------------------
*/
DROP FUNCTION IF EXISTS camdecmps.get_hourly_param_fuel_flow_pivoted(text, numeric, text[]);
DROP FUNCTION IF EXISTS camdecmps.get_hourly_param_fuel_flow_pivoted(character varying, numeric, text[]);

CREATE OR REPLACE FUNCTION camdecmps.get_hourly_param_fuel_flow_pivoted(
...
--------------------------------------------------------------------------------
SELECT *
FROM camdecmps.get_hourly_param_fuel_flow_pivoted(
