DROP FUNCTION IF EXISTS camdecmps.rpt_qa_ff2ltst(text) CASCADE;

CREATE OR REPLACE FUNCTION camdecmps.rpt_qa_ff2ltst(
	testsumid text)
    RETURNS TABLE(
		"testBasis" text,
		"avgPctDiff" numeric,
...
SELECT
	...
	FROM camdecmps.fuel_flow_to_load_check tst
