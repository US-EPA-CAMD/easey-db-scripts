-- FUNCTION: camdecmps.rpt_mp_unit_control(character varying)

CREATE OR REPLACE FUNCTION camdecmps.rpt_mp_unit_control
(
...
AS $BODY$
    ...
    select  unt.unitid as "unitIdentifier",
      ...
      from  camdecmps.MONITOR_PLAN_LOCATION mpl
            ...
            join camdecmps.UNIT_CONTROL unc using ( unit_id )
