DROP FUNCTION IF EXISTS camdecmps.rpt_qa_rata_flow_run(text,text);

CREATE OR REPLACE FUNCTION camdecmps.rpt_qa_rata_flow_run(
	testsumid text,
	oplevelcd text)
    RETURNS TABLE(
		"runNum" numeric,
...
SELECT
	...
	FROM camdecmps.flow_rata_run frr
