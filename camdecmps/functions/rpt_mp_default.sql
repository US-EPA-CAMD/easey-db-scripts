-- FUNCTION: camdecmps.rpt_mp_default(character varying)

DROP FUNCTION IF EXISTS camdecmps.rpt_mp_default(character varying) CASCADE;

CREATE OR REPLACE FUNCTION camdecmps.rpt_mp_default(
...
SELECT
		...
		camdecmps.format_date_hour(md.begin_date, md.begin_hour, null) AS "beginDateHour",
		camdecmps.format_date_hour(md.end_date, md.end_hour, null) AS "endDateHour"
	FROM camdecmps.monitor_default md
