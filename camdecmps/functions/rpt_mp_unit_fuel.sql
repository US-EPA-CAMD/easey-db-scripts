...
SELECT
		...
		camdecmps.format_indicator(uf.ozone_seas_ind, true) AS "ozoneSeasonIndicator",
		camdecmps.format_date_hour(uf.begin_date, null, null) AS "beginDate",
		camdecmps.format_date_hour(uf.end_date, null, null) AS "beginDate"
	FROM camdecmps.unit_fuel uf
