DROP FUNCTION IF EXISTS camdecmps.rpt_qa_ffl2bas(text) CASCADE;

CREATE OR REPLACE FUNCTION camdecmps.rpt_qa_ffl2bas(
	testsumid text)
    RETURNS TABLE(
		"avgFlowRate" numeric,
...
SELECT
	...
	FROM camdecmps.fuel_flow_to_load_baseline bas
