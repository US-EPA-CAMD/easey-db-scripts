...
BEGIN
	...
	LEFT OUTER JOIN camdecmps.DERIVED_HRLY_VALUE AS NOX_DHV 
		ON HOD.HOUR_ID = NOX_DHV.HOUR_ID AND NOX_DHV.PARAMETER_CD = 'NOX' 
	LEFT OUTER JOIN camdecmps.DERIVED_HRLY_VALUE AS HI_DHV 
		ON HOD.HOUR_ID = HI_DHV.HOUR_ID AND HI_DHV.PARAMETER_CD = 'HI' 
	LEFT OUTER JOIN camdecmps.MONITOR_HRLY_VALUE AS NOXC_MHV 
	...
	LEFT OUTER JOIN camdecmps.MONITOR_HRLY_VALUE AS MHV_CO2C 
		ON DHV.HOUR_ID = MHV_CO2C.HOUR_ID AND MHV_CO2C.PARAMETER_CD = 'CO2C' 
		AND MHV_CO2C.MODC_CD NOT IN ('47', '48')
	LEFT OUTER JOIN camdecmps.MONITOR_HRLY_VALUE AS MHV_O2C_DRY 
	...
	LEFT OUTER JOIN camdecmps.MONITOR_HRLY_VALUE AS MHV_O2C_WET 
