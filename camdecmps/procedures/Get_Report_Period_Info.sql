CREATE OR REPLACE FUNCTION camdecmps.GetReportPeriodInfo(
	IN p_rptPeriodId_in				int				, 
	INOUT p_calendarYear_in			int				,
	INOUT p_quarter_in				int				,
	INOUT p_periodDescription_in	varchar(100)	,
	INOUT p_periodAbbreviation_in	varchar(32)		,
	INOUT p_beginDate				date			,
	INOUT p_endDate					date			,
	INOUT p_result					character(1)	,
