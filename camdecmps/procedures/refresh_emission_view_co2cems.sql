-- PROCEDURE: camdecmps.refresh_emission_view_co2cems()

DROP PROCEDURE IF EXISTS camdecmps.refresh_emission_view_co2cems();

CREATE OR REPLACE PROCEDURE camdecmps.refresh_emission_view_co2cems()
LANGUAGE 'plpgsql'
AS $BODY$
BEGIN
	TRUNCATE camdecmps.EMISSION_VIEW_CO2CEMS RESTART IDENTITY;
