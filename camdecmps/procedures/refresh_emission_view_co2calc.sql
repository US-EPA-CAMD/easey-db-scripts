-- PROCEDURE: camdecmps.refresh_emission_view_co2calc()

DROP PROCEDURE IF EXISTS camdecmps.refresh_emission_view_co2calc();

CREATE OR REPLACE PROCEDURE camdecmps.refresh_emission_view_co2calc()
LANGUAGE 'plpgsql'
AS $BODY$
BEGIN
	TRUNCATE camdecmps.EMISSION_VIEW_CO2CALC RESTART IDENTITY;
