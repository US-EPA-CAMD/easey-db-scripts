-- PROCEDURE: camdecmps.refresh_emission_view_all()

DROP PROCEDURE IF EXISTS camdecmps.refresh_emission_view_all();

CREATE OR REPLACE PROCEDURE camdecmps.refresh_emission_view_all()
LANGUAGE 'plpgsql'
AS $BODY$
BEGIN
	TRUNCATE camdecmps.EMISSION_VIEW_ALL RESTART IDENTITY;
