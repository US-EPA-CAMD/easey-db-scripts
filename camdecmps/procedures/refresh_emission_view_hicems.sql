...
BEGIN
	...
	INNER JOIN camdecmps.MONITOR_HRLY_VALUE AS MHV 
		ON DHV.HOUR_ID = MHV.HOUR_ID 
	...
	LEFT OUTER JOIN camdecmps.MONITOR_HRLY_VALUE AS MHV_CO2C_2 
		ON DHV.HOUR_ID = MHV_CO2C_2.HOUR_ID AND MHV_CO2C_2.PARAMETER_CD = 'CO2C' AND
		MHV_CO2C_2.MODC_CD IN ('06', '07', '08', '09', '10', '11', '12', '55')
	LEFT OUTER JOIN camdecmps.MONITOR_HRLY_VALUE AS MHV_O2C_DRY 
		ON DHV.HOUR_ID = MHV_O2C_DRY.HOUR_ID AND MHV_O2C_DRY.PARAMETER_CD = 'O2C' AND (
			MHV_O2C_DRY.MOISTURE_BASIS IS NULL OR MHV_O2C_DRY.MOISTURE_BASIS = 'D'
		) 
	LEFT OUTER JOIN camdecmps.MONITOR_HRLY_VALUE AS MHV_O2C_DRY_2 
		ON DHV.HOUR_ID = MHV_O2C_DRY_2.HOUR_ID AND MHV_O2C_DRY_2.PARAMETER_CD = 'O2C' AND (
	...
	LEFT OUTER JOIN camdecmps.MONITOR_HRLY_VALUE AS MHV_O2C_WET 
		ON DHV.HOUR_ID = MHV_O2C_WET.HOUR_ID AND MHV_O2C_WET.PARAMETER_CD = 'O2C' AND (
			MHV_O2C_WET.MOISTURE_BASIS IS NULL OR MHV_O2C_WET.MOISTURE_BASIS = 'W'
		) 
	LEFT OUTER JOIN camdecmps.MONITOR_HRLY_VALUE AS MHV_O2C_WET_2 
		ON DHV.HOUR_ID = MHV_O2C_WET_2.HOUR_ID AND MHV_O2C_WET_2.PARAMETER_CD = 'O2C' AND (
