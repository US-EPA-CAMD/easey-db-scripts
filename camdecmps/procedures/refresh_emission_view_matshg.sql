...
BEGIN
	...
	LEFT OUTER JOIN camdecmps.MONITOR_SYSTEM AS MSYS 
	...
	LEFT OUTER JOIN camdecmps.HRLY_GAS_FLOW_METER GFM1 
	...
	LEFT OUTER JOIN camdecmps.HRLY_GAS_FLOW_METER GFM2 
	...
	LEFT OUTER JOIN camdecmps.COMPONENT CMP1 
