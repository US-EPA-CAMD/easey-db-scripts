ALTER TABLE IF EXISTS camdecmpsmd.check_catalog
    ...
    ADD CONSTRAINT fk_check_catalog_check_type_code FOREIGN (check_type_cd)
        REFERENCES camdecmpsmd.check_type_code (check_type_cd) MATCH SIMPLE,
    ADD CONSTRAINT fk_check_catalog_check_applicability_code FOREIGN (check_applicability_cd)
        REFERENCES camdecmpsmd.check_applicability_code (check_applicability_cd) MATCH SIMPLE,
    ADD CONSTRAINT fk_check_catalog_check_status_code FOREIGN (check_status_cd)
