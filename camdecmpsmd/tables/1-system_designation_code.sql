-- Table: camdecmpsmd.system_designation_code

-- DROP TABLE camdecmpsmd.system_designation_code;
...
(
    ...
    CONSTRAINT pk_system_designation_code PRIMARY KEY (sys_designation_cd)
);
