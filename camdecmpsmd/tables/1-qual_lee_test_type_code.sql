-- Table: camdecmpsmd.qual_lee_test_type_code

-- DROP TABLE camdecmpsmd.qual_lee_test_type_code;
...
(
    ...
    CONSTRAINT pk_qual_lee_test_type_code PRIMARY KEY (qual_lee_test_type_cd)
);
