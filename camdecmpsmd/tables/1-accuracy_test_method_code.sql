-- Table: camdecmpsmd.accuracy_test_method_code

-- DROP TABLE camdecmpsmd.accuracy_test_method_code;
...
(
    ...
    CONSTRAINT pk_accuracy_test_method_code PRIMARY KEY (acc_test_method_cd)
);
