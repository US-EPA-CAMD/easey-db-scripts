-- Table: camdecmpsmd.fuel_group_code

-- DROP TABLE camdecmpsmd.fuel_group_code;
...
(
    ...
    CONSTRAINT pk_fuel_group_code PRIMARY KEY (fuel_group_cd),
    CONSTRAINT uq_fuel_group_code_desc UNIQUE (fuel_group_description)
);
