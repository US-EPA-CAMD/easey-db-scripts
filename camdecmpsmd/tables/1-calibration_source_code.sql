-- Table: camdecmpsmd.calibration_source_code

-- DROP TABLE camdecmpsmd.calibration_source_code;
...
(
    ...
    CONSTRAINT pk_calibration_source_code PRIMARY KEY (cal_source_cd)
);
