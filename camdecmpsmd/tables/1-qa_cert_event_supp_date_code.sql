-- Table: camdecmpsmd.qa_cert_event_supp_date_code

-- DROP TABLE camdecmpsmd.qa_cert_event_supp_date_code;

CREATE TABLE camdecmpsmd.qa_cert_event_supp_date_code
(
    ...
    CONSTRAINT pk_qa_cert_event_supp_date_cd PRIMARY KEY (qa_cert_event_supp_date_cd)
);
