-- Table: camdecmpsmd.qa_cert_event_supp_data_code

-- DROP TABLE camdecmpsmd.qa_cert_event_supp_data_code;
...
(
    ...
    CONSTRAINT pk_qa_cert_event_supp_data_cd PRIMARY KEY (qa_cert_event_supp_data_cd)
);
