-- Table: camdecmpsmd.injection_protocol_code

-- DROP TABLE camdecmpsmd.injection_protocol_code;
...
(
    ...
    CONSTRAINT pk_injection_protocol_code PRIMARY KEY (injection_protocol_cd)
);
