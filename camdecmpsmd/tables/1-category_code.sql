-- Table: camdecmpsmd.category_code

-- DROP TABLE camdecmpsmd.category_code;
...
(
    ...
    CONSTRAINT pk_category_code PRIMARY KEY (category_cd)
);
...
-- Index: idx_category_code_process_cd
