-- Table: camdecmpsmd.analytical_principle_code

-- DROP TABLE camdecmpsmd.analytical_principle_code;
...
(
    ...
    CONSTRAINT pk_analytical_principle_code PRIMARY KEY (analytical_principle_cd)
);
