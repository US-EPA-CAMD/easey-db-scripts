...
BEGIN
    ...
    insert 
      into  camdecmpswks.EMISSION_VIEW_SO2CEMS
            (
                MON_PLAN_ID,
                MON_LOC_ID,
                RPT_PERIOD_ID,
    ...
    select  dat.MON_PLAN_ID, 
            ...
            dat.SO2C_UNADJUSTED_HRLY_VALUE as UNADJ_SO2, 
            dat.SO2C_APPLICABLE_BIAS_ADJ_FACTOR as SO2_BAF, 
            dat.SO2C_ADJUSTED_HRLY_VALUE as RPT_ADJ_SO2, 
            dat.SO2C_CALC_ADJUSTED_HRLY_VALUE  as CALC_ADJ_SO2, 
            dat.SO2C_MODC_CD as SO2_MODC, 
            dat.SO2C_PCT_AVAILABLE as SO2_PMA,
            dat.FLOW_UNADJUSTED_HRLY_VALUE as UNADJ_FLOW, 
            dat.FLOW_APPLICABLE_BIAS_ADJ_FACTOR as FLOW_BAF, 
            ...
            dat.SO2_CALC_PCT_MOISTURE as PCT_H2O_USED, 
            case 
                when (dat.SO2_CALC_PCT_MOISTURE is not null) then 
                    case 
            ...
            dat.SO2_FORMULA_CD as SO2_FORMULA_CD, 
            dat.SO2_ADJUSTED_HRLY_VALUE as RPT_SO2_MASS_RATE, 
            dat.SO2_CALC_ADJUSTED_HRLY_VALUE as CALC_SO2_MASS_RATE, 
            case ( dat.SO2_FORMULA_CD )
                when 'F-23'
                then dat.HI_CALC_ADJUSTED_HRLY_VALUE
            end as CALC_HI_RATE, 
            case ( dat.SO2_FORMULA_CD )
                when 'F-23'
                then dat.SO2R_F23_DEFAULT_VALUE
      ...
      from  (
                select  hod.HOUR_ID,
                        ...
                        ems.CHK_SESSION_ID,
                        -- SO2
                        max( case when dhv.PARAMETER_CD = 'SO2'  then dhv.HOUR_ID end ) as SO2_HOUR_ID,
                        max( case when dhv.PARAMETER_CD = 'SO2'  then dhv.ADJUSTED_HRLY_VALUE end ) as SO2_ADJUSTED_HRLY_VALUE,
                        max( case when dhv.PARAMETER_CD = 'SO2'  then dhv.CALC_ADJUSTED_HRLY_VALUE end ) as SO2_CALC_ADJUSTED_HRLY_VALUE,
                        max( case when dhv.PARAMETER_CD = 'SO2'  then dhv.CALC_PCT_MOISTURE end ) as SO2_CALC_PCT_MOISTURE,
                        ...
                        max( case when mhv.PARAMETER_CD = 'SO2C' then mhv.APPLICABLE_BIAS_ADJ_FACTOR end ) as SO2C_APPLICABLE_BIAS_ADJ_FACTOR,
                        max( case when mhv.PARAMETER_CD = 'SO2C' then mhv.ADJUSTED_HRLY_VALUE end ) as SO2C_ADJUSTED_HRLY_VALUE,
                        max( case when mhv.PARAMETER_CD = 'SO2C' then mhv.CALC_ADJUSTED_HRLY_VALUE end ) as SO2C_CALC_ADJUSTED_HRLY_VALUE,
                        ...
                        -- Default Information
                        max( def.DEFAULT_VALUE ) as SO2R_F23_DEFAULT_VALUE
                  from  (
                        ...
                        join camdecmpswks.DERIVED_HRLY_VALUE dhv
                         ...
                         and dhv.PARAMETER_CD in ( 'SO2', 'H2O', 'HI' )
                        join camdecmpswks.MONITOR_HRLY_VALUE mhv
                         ...
                         and mhv.PARAMETER_CD in ( 'FLOW', 'H2O', 'SO2C' )
 ...
 where  (
            dat.SO2_HOUR_ID is not null and
