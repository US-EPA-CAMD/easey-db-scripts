CREATE OR REPLACE PROCEDURE camdecmps.refresh_emission_view_all(IN vmonplanid character varying, IN vrptperiodid numeric)
 LANGUAGE plpgsql
AS $procedure$
DECLAREBEGIN
      ...
      from  (
                select  hod.HOUR_ID,
                  ...
                  from  (
                        ...
                        left join camdecmps.MONITOR_HRLY_VALUE flow
