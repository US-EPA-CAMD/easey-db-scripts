ALTER TABLE IF EXISTS camdecmpsaux.mats_data_submission
    ...
    ADD CONSTRAINT fk_mats_data_submission_mats_report_type_code FOREIGN KEY (mats_rpt_type_cd) REFERENCES camdecmpsmd.mats_report_type_code (mats_rpt_type_cd) MATCH simple,
    ADD CONSTRAINT fk_mats_data_submission_mats_averaging_group_code FOREIGN KEY (mats_avg_group_cd) REFERENCES camdecmpsmd.mats_averaging_group_code (mats_avg_group_cd) MATCH simple,
    ADD CONSTRAINT fk_mats_data_submission FOREIGN KEY (original_sub_id) REFERENCES camdecmpsaux.mats_data_submission (mats_data_sub_id) MATCH simple,
    ...
    ADD CONSTRAINT fk_mats_data_submission_mats_status_code FOREIGN KEY (mats_status_cd) REFERENCES camdecmpsmd.mats_status_code (mats_status_cd) MATCH simple;
