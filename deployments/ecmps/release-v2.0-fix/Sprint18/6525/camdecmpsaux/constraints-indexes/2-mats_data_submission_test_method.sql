ALTER TABLE IF EXISTS camdecmpsaux.mats_data_submission_test_method
    ...
    ADD CONSTRAINT fk_mats_data_submission_test_method_mats_test_method_code FOREIGN KEY (mats_test_meth_cd) REFERENCES camdecmpsaux.mats_test_method_code (mats_test_meth_cd) MATCH simple;
