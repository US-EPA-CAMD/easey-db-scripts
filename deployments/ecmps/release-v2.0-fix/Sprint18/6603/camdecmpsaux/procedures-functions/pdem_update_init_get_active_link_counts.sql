create or replace function camdecmpsaux.PDEM_Update_Init_Get_Active_Link_Counts
(
          ...
          from  (
                    select  distinct
                     ...
                     where  vReportBeginDate <= vReportEndDate
                       and  coalesce( cmb.Begin_Date, vReportBeginDate ) <= vReportEndDate
                       and  coalesce( cmb.End_Date, vReportEndDate ) >= vReportBeginDate
                ) lst;
