-- FUNCTION: camdecmps.rpt_em_emission_summary(text, text, text)

-- DROP FUNCTION IF EXISTS camdecmps.rpt_em_emission_summary(text, text, text);

CREATE OR REPLACE FUNCTION camdecmps.rpt_em_emission_summary(
	p_mon_plan_id text,
	p_loc_id text,
...
GRANT EXECUTE ON FUNCTION camdecmps.rpt_em_emission_summary(text, text, text) TO PUBLIC;

GRANT EXECUTE ON FUNCTION camdecmps.rpt_em_emission_summary(text, text, text) TO "r_quartz-scheduler";

GRANT EXECUTE ON FUNCTION camdecmps.rpt_em_emission_summary(text, text, text) TO uryp8x9bvx7lbph4;
