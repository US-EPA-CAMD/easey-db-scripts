CREATE OR REPLACE PROCEDURE camdecmps.refresh_emission_view_hiunitstack(IN vmonplanid character varying, IN vrptperiodid numeric)
 LANGUAGE plpgsql
AS $procedure$
DECLARE 
...
BEGIN
  ...
  RAISE NOTICE 'Refreshing view data...';
	...
	LEFT JOIN camdecmps.MONITOR_HRLY_VALUE AS MHV 
