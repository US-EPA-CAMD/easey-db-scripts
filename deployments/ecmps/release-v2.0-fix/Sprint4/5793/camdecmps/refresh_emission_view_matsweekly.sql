CREATE OR REPLACE PROCEDURE camdecmps.refresh_emission_view_matsweekly(IN vmonplanid character varying, IN vrptperiodid numeric)
 LANGUAGE plpgsql
AS $procedure$
BEGIN
  ...
  RAISE NOTICE 'Refreshing view data...';
	...
	LEFT JOIN	camdecmps.WEEKLY_TEST_SUMMARY wts 
	...
	LEFT JOIN camdecmps.MONITOR_SPAN MS  
