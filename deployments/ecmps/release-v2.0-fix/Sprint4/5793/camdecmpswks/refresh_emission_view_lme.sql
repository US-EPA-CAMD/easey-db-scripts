CREATE OR REPLACE PROCEDURE camdecmpswks.refresh_emission_view_lme(IN vmonplanid character varying, IN vrptperiodid numeric)
 LANGUAGE plpgsql
AS $procedure$
DECLARE
...
BEGIN
  ...
  RAISE NOTICE 'Refreshing view data...';
   ...
   FROM temp_hourly_test_errors AS hod 
    ...
    LEFT JOIN camdecmpswks.MONITOR_DEFAULT as SO2R_MD 
        ON HOD.MON_LOC_ID = SO2R_MD.MON_LOC_ID
        AND camdecmpswks.emissions_monitor_default_active(SO2R_MD.BEGIN_DATE, SO2R_MD.BEGIN_HOUR, SO2R_MD.END_DATE, SO2R_MD.END_HOUR, HOD.BEGIN_DATE, HOD.BEGIN_HOUR) = 1 
    ...
    LEFT JOIN camdecmpswks.MONITOR_DEFAULT AS NOXR_MD 
    ...
    LEFT JOIN camdecmpswks.MONITOR_DEFAULT AS NORX_MD 
    ...
    LEFT JOIN camdecmpswks.MONITOR_DEFAULT AS CO2R_MD 
        ON HOD.MON_LOC_ID = CO2R_MD.MON_LOC_ID
        AND camdecmpswks.emissions_monitor_default_active(CO2R_MD.BEGIN_DATE, CO2R_MD.BEGIN_HOUR, CO2R_MD.END_DATE, CO2R_MD.END_HOUR, HOD.BEGIN_DATE, HOD.BEGIN_HOUR) = 1 
