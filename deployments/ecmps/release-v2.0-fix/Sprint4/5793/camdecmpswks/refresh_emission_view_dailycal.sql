CREATE OR REPLACE PROCEDURE camdecmpswks.refresh_emission_view_dailycal(IN vmonplanid character varying, IN vrptperiodid numeric)
 LANGUAGE plpgsql
AS $procedure$
BEGIN
  ...
  RAISE NOTICE 'Refreshing view data...';
	...
	JOIN camdecmpswks.DAILY_CALIBRATION AS DC
		ON DTS.DAILY_TEST_SUM_ID = DC.DAILY_TEST_SUM_ID
	LEFT JOIN camdecmpswks.MONITOR_SPAN AS MS
