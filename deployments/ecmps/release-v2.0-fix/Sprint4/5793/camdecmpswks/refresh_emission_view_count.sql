CREATE OR REPLACE PROCEDURE camdecmpswks.refresh_emission_view_count(IN vmonplanid character varying, IN vrptperiodid numeric, IN vdatasetcode character varying)
 LANGUAGE plpgsql
AS $procedure$
DECLARE
	sqlStatement text;
