...
VALUES
    ...
    (datatableId, 2, 'op_hours', 'opHours', '# of Op. Hours'),
    (datatableId, 3, 'op_time', 'opTime', 'Op. Time (hrs)'),
    (datatableId, 4, 'heat_input', 'heatInput', 'Heat Input (mmBtu)'),
    (datatableId, 5, 'so2_mass', 'so2Mass', 'SO2 Mass (tons)'),
    (datatableId, 6, 'co2_mass', 'co2Mass', 'CO2 Mass (tons)'),
    (datatableId, 7, 'nox_rate', 'noxRate', 'NOx Rate (lb/mmBtu)'),
    (datatableId, 8, 'nox_mass', 'noxMass', 'NOx Mass (tons)');
