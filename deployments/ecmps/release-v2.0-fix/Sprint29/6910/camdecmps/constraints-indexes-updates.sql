--BEGIN;
	...
	ALTER TABLE camdecmps.mats_derived_hrly_value DROP CONSTRAINT IF EXISTS pk_mats_derived_hrly_value;
	ALTER TABLE camdecmps.mats_monitor_hrly_value DROP CONSTRAINT IF EXISTS pk_mats_monitor_hrly_value;
	ALTER TABLE camdecmps.monitor_hrly_value 	  DROP CONSTRAINT IF EXISTS pk_monitor_hrly_value;
	ALTER TABLE camdecmps.hrly_param_fuel_flow    DROP CONSTRAINT IF EXISTS pk_hrly_param_fuel_flow;
