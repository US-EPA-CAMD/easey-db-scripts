-- FUNCTION: camdecmps.rpt_mp_unit_program(character varying)

DROP FUNCTION IF EXISTS camdecmps.rpt_mp_unit_program(character varying);

CREATE OR REPLACE FUNCTION camdecmps.rpt_mp_unit_program(
...
SELECT
		...
		camdecmps.format_date_hour(up.unit_monitor_cert_begin_date, null, null) AS "unitMonitorCertBeginDate",
		camdecmps.format_date_hour(up.unit_monitor_cert_deadline, null, null) AS "unitMonitorCertDeadline",
		camdecmps.format_date_hour(up.end_date, null, null) AS "endDate"
