CREATE OR REPLACE PROCEDURE camdecmpswks.refresh_emission_view_hicems(IN vmonplanid character varying, IN vrptperiodid numeric)
 LANGUAGE plpgsql
AS $procedure$
DECLARE  
...
BEGIN
  ...
  RAISE NOTICE 'Refreshing view data...';
    ...
    LEFT JOIN camdecmpswks.MONITOR_DEFAULT AS H2O_MD 
    ...
    WHERE dhv.hi_hour_id IS NOT NULL
      AND mhv.flow_hour_id IS NOT NULL
      AND coalesce(mhv.o2c_d_modc_cd,'0') not in ('47','48') and coalesce(mhv.o2c_w_modc_cd,'0') not in ('47','48');
