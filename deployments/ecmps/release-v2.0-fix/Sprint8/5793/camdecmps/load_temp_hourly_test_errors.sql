-- PROCEDURE: camdecmps.load_temp_hourly_test_errors(character varying, numeric)

DROP PROCEDURE IF EXISTS camdecmps.load_temp_hourly_test_errors(character varying, numeric);
...
BEGIN
  IF NOT EXISTS (
    ...
    CREATE INDEX IF NOT EXISTS idx_temp_hourly_test_errors_hour_id
    ...
    EXECUTE 'analyze ' || quote_ident('temp_hourly_test_errors');
