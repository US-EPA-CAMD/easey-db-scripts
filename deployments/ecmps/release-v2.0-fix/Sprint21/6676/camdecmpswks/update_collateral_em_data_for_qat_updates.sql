-- FUNCTION: camdecmpswks.update_collateral_em_data_for_qat_updates(character varying)

-- DROP FUNCTION IF EXISTS camdecmpswks.update_collateral_em_data_for_qat_updates(character varying);

CREATE OR REPLACE FUNCTION camdecmpswks.update_collateral_em_data_for_qat_updates(
...
exception when others then
    ...
    result = 'F';
    error_msg :='From update_collateral_em_data_for_qat_updates ' ||' '|| error_msg;
