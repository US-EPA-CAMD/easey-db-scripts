...
BEGIN
	...
	VALUES(datasetCode, groupCode, 'Hourly Combined Parameters View', 1, 'Hourly Combined Parameters data does not exist for the specified monitor plan and reporting period.');
