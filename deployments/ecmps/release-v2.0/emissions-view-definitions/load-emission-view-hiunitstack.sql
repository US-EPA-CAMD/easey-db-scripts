...
BEGIN
	...
	VALUES(datasetCode, groupCode, 'Heat Input for Unit/Stack View', 7, 'Heat Input for Unit/Stack data does not exist for the specified monitor plan and reporting period.');
