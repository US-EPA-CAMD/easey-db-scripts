...
BEGIN
	...
	VALUES(datasetCode, 'EMVIEW', 'CO2 Daily Fuel Sampling View', 22, 'CO2 Daily Fuel Sampling data does not exist for the specified monitor plan and reporting period.');
