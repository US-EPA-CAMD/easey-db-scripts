...
VALUES
  ...
  ('ERRDTL',        'ERRDTL',   'DEFAULT',	'Error Details'),
    ...
    ('UNITSTACK',     'MPP',		  'DEFAULT',	'Relationship Data'),
    ('RECTDUCTWAF',   'MPP',		  'DEFAULT',	'Rectangular Duct WAF'),
    ('UNITCONTROL',   'MPP',		  'DEFAULT',	'Unit Controls'),
  ...
  ('DAHSSUM',       'DAHS',     '3COLTBL',	'DAHS Verification'),
  ('DGFMCALSUM',    'DGFMCAL',  '3COLTBL',	'Dry Gas Meter Calibration (Sorbent Trap Monitoring System)'),
  ('LEAKSUM',       'LEAK',     '3COLTBL',	'Leak Check'),
  ('MFMCALSUM',     'MFMCAL',   '3COLTBL',	'Mass Flow Meter Calibration (Sorbent Trap Monitoring System)'),
