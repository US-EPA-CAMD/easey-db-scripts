...
ALTER TABLE IF EXISTS camdecmpsaux.apportionment ALTER COLUMN apport_id TYPE bigint;
...
ALTER TABLE IF EXISTS camdecmpsaux.pdem_mats_unit_hour ALTER COLUMN unit_id TYPE bigint;
ALTER TABLE IF EXISTS camdecmpsaux.pdem_p75_unit_hour ALTER COLUMN unit_id TYPE bigint;
ALTER TABLE IF EXISTS camdecmpsaux.program_parameter ALTER COLUMN prg_id TYPE bigint, ALTER COLUMN prg_param_id TYPE bigint;
