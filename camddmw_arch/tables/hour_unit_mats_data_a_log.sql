...
CREATE INDEX IF NOT EXISTS idx_hour_unit_mats_data_a_log_sql_function
    ON camddmw_arch.hour_unit_mats_data_a_log USING btree
    (sql_function ASC NULLS LAST);

CREATE INDEX IF NOT EXISTS idx_hour_unit_mats_data_a_log_unit_id
    ON camddmw_arch.hour_unit_mats_data_a_log USING btree
    (unit_id ASC NULLS LAST);

CREATE INDEX IF NOT EXISTS idx_hour_unit_mats_data_a_log_op_date
    ON camddmw_arch.hour_unit_mats_data_a_log USING btree
    (op_date ASC NULLS LAST);

CREATE INDEX IF NOT EXISTS idx_hour_unit_mats_data_a_log_op_hour
    ON camddmw_arch.hour_unit_mats_data_a_log USING btree
