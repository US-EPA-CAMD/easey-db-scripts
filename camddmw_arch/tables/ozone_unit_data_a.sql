-- Table: camddmw_arch.ozone_unit_data_a

-- DROP TABLE camddmw_arch.ozone_unit_data_a;

CREATE TABLE IF NOT EXISTS camddmw_arch.ozone_unit_data_a
(
...
CREATE TABLE IF NOT EXISTS camddmw_arch.ozone_unit_data_a_dm_em_uo_1995 PARTITION OF camddmw_arch.ozone_unit_data_a
    FOR VALUES FROM ('1995') TO ('1996');

--ALTER TABLE camddmw_arch.ozone_unit_data_a_dm_em_uo_1995
--    OWNER to "uImcwuf4K9dyaxeL";

CREATE TABLE IF NOT EXISTS camddmw_arch.ozone_unit_data_a_dm_em_uo_1996 PARTITION OF camddmw_arch.ozone_unit_data_a
    FOR VALUES FROM ('1996') TO ('1997');

--ALTER TABLE camddmw_arch.ozone_unit_data_a_dm_em_uo_1996
--    OWNER to "uImcwuf4K9dyaxeL";

CREATE TABLE IF NOT EXISTS camddmw_arch.ozone_unit_data_a_dm_em_uo_1997 PARTITION OF camddmw_arch.ozone_unit_data_a
    FOR VALUES FROM ('1997') TO ('1998');

--ALTER TABLE camddmw_arch.ozone_unit_data_a_dm_em_uo_1997
--    OWNER to "uImcwuf4K9dyaxeL";

CREATE TABLE IF NOT EXISTS camddmw_arch.ozone_unit_data_a_dm_em_uo_1998 PARTITION OF camddmw_arch.ozone_unit_data_a
    FOR VALUES FROM ('1998') TO ('1999');

--ALTER TABLE camddmw_arch.ozone_unit_data_a_dm_em_uo_1998
--    OWNER to "uImcwuf4K9dyaxeL";

CREATE TABLE IF NOT EXISTS camddmw_arch.ozone_unit_data_a_dm_em_uo_1999 PARTITION OF camddmw_arch.ozone_unit_data_a
    FOR VALUES FROM ('1999') TO ('2000');

--ALTER TABLE camddmw_arch.ozone_unit_data_a_dm_em_uo_1999
--    OWNER to "uImcwuf4K9dyaxeL";

CREATE TABLE IF NOT EXISTS camddmw_arch.ozone_unit_data_a_dm_em_uo_2000 PARTITION OF camddmw_arch.ozone_unit_data_a
    FOR VALUES FROM ('2000') TO ('2001');

--ALTER TABLE camddmw_arch.ozone_unit_data_a_dm_em_uo_2000
--    OWNER to "uImcwuf4K9dyaxeL";

CREATE TABLE IF NOT EXISTS camddmw_arch.ozone_unit_data_a_dm_em_uo_2001 PARTITION OF camddmw_arch.ozone_unit_data_a
    FOR VALUES FROM ('2001') TO ('2002');

--ALTER TABLE camddmw_arch.ozone_unit_data_a_dm_em_uo_2001
--    OWNER to "uImcwuf4K9dyaxeL";

CREATE TABLE IF NOT EXISTS camddmw_arch.ozone_unit_data_a_dm_em_uo_2002 PARTITION OF camddmw_arch.ozone_unit_data_a
    FOR VALUES FROM ('2002') TO ('2003');

--ALTER TABLE camddmw_arch.ozone_unit_data_a_dm_em_uo_2002
--    OWNER to "uImcwuf4K9dyaxeL";

CREATE TABLE IF NOT EXISTS camddmw_arch.ozone_unit_data_a_dm_em_uo_2003 PARTITION OF camddmw_arch.ozone_unit_data_a
    FOR VALUES FROM ('2003') TO ('2004');

--ALTER TABLE camddmw_arch.ozone_unit_data_a_dm_em_uo_2003
--    OWNER to "uImcwuf4K9dyaxeL";

CREATE TABLE IF NOT EXISTS camddmw_arch.ozone_unit_data_a_dm_em_uo_2004 PARTITION OF camddmw_arch.ozone_unit_data_a
    FOR VALUES FROM ('2004') TO ('2005');

--ALTER TABLE camddmw_arch.ozone_unit_data_a_dm_em_uo_2004
--    OWNER to "uImcwuf4K9dyaxeL";

CREATE TABLE IF NOT EXISTS camddmw_arch.ozone_unit_data_a_dm_em_uo_2005 PARTITION OF camddmw_arch.ozone_unit_data_a
    FOR VALUES FROM ('2005') TO ('2006');

--ALTER TABLE camddmw_arch.ozone_unit_data_a_dm_em_uo_2005
--    OWNER to "uImcwuf4K9dyaxeL";

CREATE TABLE IF NOT EXISTS camddmw_arch.ozone_unit_data_a_dm_em_uo_2006 PARTITION OF camddmw_arch.ozone_unit_data_a
    FOR VALUES FROM ('2006') TO ('2007');

--ALTER TABLE camddmw_arch.ozone_unit_data_a_dm_em_uo_2006
--    OWNER to "uImcwuf4K9dyaxeL";

CREATE TABLE IF NOT EXISTS camddmw_arch.ozone_unit_data_a_dm_em_uo_2007 PARTITION OF camddmw_arch.ozone_unit_data_a
    FOR VALUES FROM ('2007') TO ('2008');

--ALTER TABLE camddmw_arch.ozone_unit_data_a_dm_em_uo_2007
--    OWNER to "uImcwuf4K9dyaxeL";

CREATE TABLE IF NOT EXISTS camddmw_arch.ozone_unit_data_a_dm_em_uo_2008 PARTITION OF camddmw_arch.ozone_unit_data_a
    FOR VALUES FROM ('2008') TO ('2009');

--ALTER TABLE camddmw_arch.ozone_unit_data_a_dm_em_uo_2008
--    OWNER to "uImcwuf4K9dyaxeL";

CREATE TABLE IF NOT EXISTS camddmw_arch.ozone_unit_data_a_dm_em_uo_2009 PARTITION OF camddmw_arch.ozone_unit_data_a
    FOR VALUES FROM ('2009') TO ('2010');

--ALTER TABLE camddmw_arch.ozone_unit_data_a_dm_em_uo_2009
--    OWNER to "uImcwuf4K9dyaxeL";

CREATE TABLE IF NOT EXISTS camddmw_arch.ozone_unit_data_a_dm_em_uo_2010 PARTITION OF camddmw_arch.ozone_unit_data_a
    FOR VALUES FROM ('2010') TO ('2011');

--ALTER TABLE camddmw_arch.ozone_unit_data_a_dm_em_uo_2010
--    OWNER to "uImcwuf4K9dyaxeL";

CREATE TABLE IF NOT EXISTS camddmw_arch.ozone_unit_data_a_dm_em_uo_2011 PARTITION OF camddmw_arch.ozone_unit_data_a
    FOR VALUES FROM ('2011') TO ('2012');

--ALTER TABLE camddmw_arch.ozone_unit_data_a_dm_em_uo_2011
--    OWNER to "uImcwuf4K9dyaxeL";

CREATE TABLE IF NOT EXISTS camddmw_arch.ozone_unit_data_a_dm_em_uo_2012 PARTITION OF camddmw_arch.ozone_unit_data_a
    FOR VALUES FROM ('2012') TO ('2013');

--ALTER TABLE camddmw_arch.ozone_unit_data_a_dm_em_uo_2012
--    OWNER to "uImcwuf4K9dyaxeL";

CREATE TABLE IF NOT EXISTS camddmw_arch.ozone_unit_data_a_dm_em_uo_2013 PARTITION OF camddmw_arch.ozone_unit_data_a
    FOR VALUES FROM ('2013') TO ('2014');

--ALTER TABLE camddmw_arch.ozone_unit_data_a_dm_em_uo_2013
--    OWNER to "uImcwuf4K9dyaxeL";

CREATE TABLE IF NOT EXISTS camddmw_arch.ozone_unit_data_a_dm_em_uo_2014 PARTITION OF camddmw_arch.ozone_unit_data_a
    FOR VALUES FROM ('2014') TO ('2015');

--ALTER TABLE camddmw_arch.ozone_unit_data_a_dm_em_uo_2014
--    OWNER to "uImcwuf4K9dyaxeL";

CREATE TABLE IF NOT EXISTS camddmw_arch.ozone_unit_data_a_dm_em_uo_2015 PARTITION OF camddmw_arch.ozone_unit_data_a
    FOR VALUES FROM ('2015') TO ('2016');

--ALTER TABLE camddmw_arch.ozone_unit_data_a_dm_em_uo_2015
--    OWNER to "uImcwuf4K9dyaxeL";

CREATE TABLE IF NOT EXISTS camddmw_arch.ozone_unit_data_a_dm_em_uo_2016 PARTITION OF camddmw_arch.ozone_unit_data_a
    FOR VALUES FROM ('2016') TO ('2017');

--ALTER TABLE camddmw_arch.ozone_unit_data_a_dm_em_uo_2016
--    OWNER to "uImcwuf4K9dyaxeL";

CREATE TABLE IF NOT EXISTS camddmw_arch.ozone_unit_data_a_dm_em_uo_before PARTITION OF camddmw_arch.ozone_unit_data_a
