-- Table: camddmw_arch.quarter_unit_data_a_log

-- DROP TABLE camddmw_arch.quarter_unit_data_a_log;

CREATE TABLE IF NOT EXISTS camddmw_arch.quarter_unit_data_a_log
(
