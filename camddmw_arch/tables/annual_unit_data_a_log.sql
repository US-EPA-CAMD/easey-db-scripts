-- Table: camddmw_arch.annual_unit_data_a_log

-- DROP TABLE camddmw_arch.annual_unit_data_a_log;

CREATE TABLE IF NOT EXISTS camddmw_arch.annual_unit_data_a_log
(
    ...
    CONSTRAINT pk_annual_unit_data_a_log PRIMARY KEY (skey)
);

CREATE INDEX IF NOT EXISTS idx_annual_unit_data_a_log_sql_function
    ON camddmw_arch.annual_unit_data_a_log USING btree
    (sql_function ASC NULLS LAST);

CREATE INDEX IF NOT EXISTS idx_annual_unit_data_a_log_unit_id
    ON camddmw_arch.annual_unit_data_a_log USING btree
    (unit_id ASC NULLS LAST);

CREATE INDEX IF NOT EXISTS idx_annual_unit_data_a_log_op_year
    ON camddmw_arch.annual_unit_data_a_log USING btree
