create or replace procedure camdecmpsaux.PDEM_Update_Public_Load_P75_Unit_Quarter 
(
...
declare
    cRoutineName constant varchar := 'PDEM_Update_Public_Load_P75_Unit_Quarter';
...
begin
    ...
    if ( not vArchived ) then
        ...
        delete
          from  camddmw.QUARTER_UNIT_DATA
         where  Op_Year = vYear
           and  Op_Quarter = vQuarter
           and  Unit_Id = any( vUnitIds );
        
        insert
          into  camddmw.QUARTER_UNIT_DATA 
                (
                    Unit_Id,
                    Op_Year,
                    Op_Quarter,
        ...
        select  dat.Unit_Id,
         ...
         where  dat.Op_Year = vYear
           and  dat.Op_Month between vBeginMonth and vEndMonth
        ...
        delete
          from  camddmw_arch.QUARTER_UNIT_DATA_A
         where  Op_Year = vYear
           and  Op_Quarter = vQuarter
           and  Unit_Id = any( vUnitIds );
        
        insert
          into  camddmw_arch.QUARTER_UNIT_DATA_A
                (
                    Unit_Id,
                    Op_Year,
                    Op_Quarter,
        ...
        select  dat.Unit_Id,
                ...
                vUserid as Userid,
                current_timestamp as Add_Date
          from  camddmw_arch.MONTH_UNIT_DATA_A dat
         where  dat.Op_Year = vYear
           and  dat.Op_Month between vBeginMonth and vEndMonth
           and  dat.Unit_Id = any( vUnitIds )
         group
