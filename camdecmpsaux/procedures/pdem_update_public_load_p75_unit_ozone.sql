create or replace procedure camdecmpsaux.PDEM_Update_Public_Load_P75_Unit_Ozone
(
...
declare
    cRoutineName constant varchar := 'PDEM_Update_Public_Load_P75_Unit_Ozone';
...
begin
    ...
    if ( not vArchived ) then
        ...
        delete
          from  camddmw.OZONE_UNIT_DATA
         where  Op_Year = vYear
           and  Unit_Id = any( vUnitIds );
        
        insert
          into  camddmw.OZONE_UNIT_DATA 
                (
                    Unit_Id,
                    Op_Year,
                    Count_Op_Time,
        ...
        select  dat.Unit_Id,
         ...
         where  dat.Op_Year = vYear
           and  dat.Op_Month between 5 and 9
        ...
        delete
          from  camddmw_arch.OZONE_UNIT_DATA_A
         where  Op_Year = vYear
           and  Unit_Id = any( vUnitIds );
        
        insert
          into  camddmw_arch.OZONE_UNIT_DATA_A 
                (
                    Unit_Id,
                    Op_Year,
                    Count_Op_Time,
