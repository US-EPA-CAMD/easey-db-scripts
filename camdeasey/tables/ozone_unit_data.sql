CREATE TABLE IF NOT EXISTS camdeasey.ozone_unit_data
(
...
COMMENT ON TABLE camdeasey.ozone_unit_data
    IS 'Ozone season emissions data at the unit level';
COMMENT ON COLUMN camdeasey.ozone_unit_data.unit_id
    IS 'Unique identifier of a unit';
COMMENT ON COLUMN camdeasey.ozone_unit_data.op_year
    IS 'Year in which data was collected';
COMMENT ON COLUMN camdeasey.ozone_unit_data.so2_mass
    IS 'Mass of SO2 (tons) emitted by a unit';
COMMENT ON COLUMN camdeasey.ozone_unit_data.nox_mass
